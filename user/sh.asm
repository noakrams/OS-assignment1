...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	38858593          	addi	a1,a1,904 # 1398 <malloc+0xe6>
      18:	4509                	li	a0,2
      1a:	00001097          	auipc	ra,0x1
      1e:	1ac080e7          	jalr	428(ra) # 11c6 <fprintf>
  memset(buf, 0, nbuf);
      22:	864a                	mv	a2,s2
      24:	4581                	li	a1,0
      26:	8526                	mv	a0,s1
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	34258593          	addi	a1,a1,834 # 13a0 <malloc+0xee>
      66:	4509                	li	a0,2
      68:	00001097          	auipc	ra,0x1
      6c:	15e080e7          	jalr	350(ra) # 11c6 <fprintf>
  exit(1);
      70:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	31050513          	addi	a0,a0,784 # 13a8 <malloc+0xf6>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      d2:	3e270713          	addi	a4,a4,994 # 14b0 <malloc+0x1fe>
    ...
    panic("runcmd");
      ...
      ec:	2c850513          	addi	a0,a0,712 # 13b0 <malloc+0xfe>
    ...
    int fd = open("/path", O_CREATE | O_RDONLY);
     ...
     112:	2aa50513          	addi	a0,a0,682 # 13b8 <malloc+0x106>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a6:	21e58593          	addi	a1,a1,542 # 13c0 <malloc+0x10e>
     1aa:	4509                	li	a0,2
     1ac:	00001097          	auipc	ra,0x1
     1b0:	01a080e7          	jalr	26(ra) # 11c6 <fprintf>
    close (fd);
     1b4:	854e                	mv	a0,s3
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     1f2:	1e258593          	addi	a1,a1,482 # 13d0 <malloc+0x11e>
     1f6:	4509                	li	a0,2
     1f8:	00001097          	auipc	ra,0x1
     1fc:	fce080e7          	jalr	-50(ra) # 11c6 <fprintf>
      exit(1);
     200:	4505                	li	a0,1
    ...
    break;
     ...
     288:	15c50513          	addi	a0,a0,348 # 13e0 <malloc+0x12e>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32a:	f8c080e7          	jalr	-116(ra) # 12b2 <malloc>
     32e:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     374:	f42080e7          	jalr	-190(ra) # 12b2 <malloc>
     378:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ce:	ee8080e7          	jalr	-280(ra) # 12b2 <malloc>
     3d2:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3d4:	4661                	li	a2,24
     3d6:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     414:	ea2080e7          	jalr	-350(ra) # 12b2 <malloc>
     418:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     41a:	4661                	li	a2,24
     41c:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     456:	e60080e7          	jalr	-416(ra) # 12b2 <malloc>
     45a:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     45c:	4641                	li	a2,16
     45e:	4581                	li	a1,0
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4a0:	06c98993          	addi	s3,s3,108 # 1508 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     504:	00898993          	addi	s3,s3,8 # 1508 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     56e:	f9e98993          	addi	s3,s3,-98 # 1508 <whitespace>
     572:	00001a97          	auipc	s5,0x1
     576:	f8ea8a93          	addi	s5,s5,-114 # 1500 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5d8:	f3498993          	addi	s3,s3,-204 # 1508 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     648:	dc4b8b93          	addi	s7,s7,-572 # 1408 <malloc+0x156>
  ...
  while(peek(ps, es, "<>")){
     ...
     65a:	d9250513          	addi	a0,a0,-622 # 13e8 <malloc+0x136>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     742:	cd260613          	addi	a2,a2,-814 # 1410 <malloc+0x15e>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     772:	cc2b0b13          	addi	s6,s6,-830 # 1430 <malloc+0x17e>
  ...
  return ret;
     ...
     7ac:	c7050513          	addi	a0,a0,-912 # 1418 <malloc+0x166>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     80e:	c1650513          	addi	a0,a0,-1002 # 1420 <malloc+0x16e>
...
0000000000000828 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     848:	bf460613          	addi	a2,a2,-1036 # 1438 <malloc+0x186>
     84c:	85ce                	mv	a1,s3
     84e:	854a                	mv	a0,s2
...
0000000000000896 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8b8:	b8ca0a13          	addi	s4,s4,-1140 # 1440 <malloc+0x18e>
  ...
  if(peek(ps, es, ";")){
     ...
     8ee:	b5e60613          	addi	a2,a2,-1186 # 1448 <malloc+0x196>
     8f2:	85ce                	mv	a1,s3
     8f4:	854a                	mv	a0,s2
...
000000000000093e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     954:	ac060613          	addi	a2,a2,-1344 # 1410 <malloc+0x15e>
  ...
  if(!peek(ps, es, ")"))
     ...
     984:	ae060613          	addi	a2,a2,-1312 # 1460 <malloc+0x1ae>
     988:	85ca                	mv	a1,s2
     98a:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     9c6:	a8e50513          	addi	a0,a0,-1394 # 1450 <malloc+0x19e>
     9ca:	fffff097          	auipc	ra,0xfffff
     9ce:	68a080e7          	jalr	1674(ra) # 54 <panic>
    panic("syntax - missing )");
     9d2:	00001517          	auipc	a0,0x1
     9d6:	a9650513          	addi	a0,a0,-1386 # 1468 <malloc+0x1b6>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     a02:	aca70713          	addi	a4,a4,-1334 # 14c8 <malloc+0x216>
...
0000000000000a7a <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     aae:	9d660613          	addi	a2,a2,-1578 # 1480 <malloc+0x1ce>
     ab2:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     ae4:	9a858593          	addi	a1,a1,-1624 # 1488 <malloc+0x1d6>
     ae8:	4509                	li	a0,2
     aea:	00000097          	auipc	ra,0x0
     aee:	6dc080e7          	jalr	1756(ra) # 11c6 <fprintf>
    panic("syntax");
     af2:	00001517          	auipc	a0,0x1
     af6:	92650513          	addi	a0,a0,-1754 # 1418 <malloc+0x166>
...
0000000000000b02 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     b18:	98448493          	addi	s1,s1,-1660 # 1498 <malloc+0x1e6>
     b1c:	4589                	li	a1,2
     b1e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     b3e:	9de48493          	addi	s1,s1,-1570 # 1518 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     b42:	06300913          	li	s2,99
     b46:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     b4a:	00001a17          	auipc	s4,0x1
     b4e:	9d1a0a13          	addi	s4,s4,-1583 # 151b <buf.0+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     b52:	00001a97          	auipc	s5,0x1
     b56:	94ea8a93          	addi	s5,s5,-1714 # 14a0 <malloc+0x1ee>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     bce:	5fc080e7          	jalr	1532(ra) # 11c6 <fprintf>
     bd2:	bf79                	j	b70 <main+0x6e>
      runcmd(parsecmd(buf));
     bd4:	00001517          	auipc	a0,0x1
     bd8:	94450513          	addi	a0,a0,-1724 # 1518 <buf.0>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f32:	f56080e7          	jalr	-170(ra) # e84 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     f4e:	c299                	beqz	a3,f54 <printint+0x16>
     f50:	0805c863          	bltz	a1,fe0 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
     f54:	2581                	sext.w	a1,a1
  neg = 0;
     f56:	4881                	li	a7,0
     f58:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
     f5e:	2601                	sext.w	a2,a2
     f60:	00000517          	auipc	a0,0x0
     f64:	58850513          	addi	a0,a0,1416 # 14e8 <digits>
     f68:	883a                	mv	a6,a4
     f6a:	2705                	addiw	a4,a4,1
     f6c:	02c5f7bb          	remuw	a5,a1,a2
     f70:	1782                	slli	a5,a5,0x20
     f72:	9381                	srli	a5,a5,0x20
     f74:	97aa                	add	a5,a5,a0
     f76:	0007c783          	lbu	a5,0(a5)
     f7a:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     f7e:	0005879b          	sext.w	a5,a1
     f82:	02c5d5bb          	divuw	a1,a1,a2
     f86:	0685                	addi	a3,a3,1
     f88:	fec7f0e3          	bgeu	a5,a2,f68 <printint+0x2a>
  if(neg)
     f8c:	00088b63          	beqz	a7,fa2 <printint+0x64>
    buf[i++] = '-';
     f90:	fd040793          	addi	a5,s0,-48
     f94:	973e                	add	a4,a4,a5
     f96:	02d00793          	li	a5,45
     f9a:	fef70823          	sb	a5,-16(a4)
     f9e:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     fa2:	02e05863          	blez	a4,fd2 <printint+0x94>
     fa6:	fc040793          	addi	a5,s0,-64
     faa:	00e78933          	add	s2,a5,a4
     fae:	fff78993          	addi	s3,a5,-1
     fb2:	99ba                	add	s3,s3,a4
     fb4:	377d                	addiw	a4,a4,-1
     fb6:	1702                	slli	a4,a4,0x20
     fb8:	9301                	srli	a4,a4,0x20
     fba:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     fbe:	fff94583          	lbu	a1,-1(s2)
     fc2:	8526                	mv	a0,s1
     fc4:	00000097          	auipc	ra,0x0
     fc8:	f58080e7          	jalr	-168(ra) # f1c <putc>
  while(--i >= 0)
     fcc:	197d                	addi	s2,s2,-1
     fce:	ff3918e3          	bne	s2,s3,fbe <printint+0x80>
}
     fd2:	70e2                	ld	ra,56(sp)
     fd4:	7442                	ld	s0,48(sp)
     fd6:	74a2                	ld	s1,40(sp)
     fd8:	7902                	ld	s2,32(sp)
    ...
    neg = 1;
     fe4:	4885                	li	a7,1
    x = -xx;
     fe6:	bf8d                	j	f58 <printint+0x1a>

0000000000000fe8 <vprintf>:
}
...
{
     fe8:	7119                	addi	sp,sp,-128
     fea:	fc86                	sd	ra,120(sp)
     fec:	f8a2                	sd	s0,112(sp)
     fee:	f4a6                	sd	s1,104(sp)
     ff0:	f0ca                	sd	s2,96(sp)
     ff2:	ecce                	sd	s3,88(sp)
     ff4:	e8d2                	sd	s4,80(sp)
     ff6:	e4d6                	sd	s5,72(sp)
     ff8:	e0da                	sd	s6,64(sp)
     ffa:	fc5e                	sd	s7,56(sp)
     ffc:	f862                	sd	s8,48(sp)
     ffe:	f466                	sd	s9,40(sp)
    1000:	f06a                	sd	s10,32(sp)
    1002:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    1006:	0005c903          	lbu	s2,0(a1)
    100a:	18090f63          	beqz	s2,11a8 <vprintf+0x1c0>
    100e:	8aaa                	mv	s5,a0
    1010:	8b32                	mv	s6,a2
    1012:	00158493          	addi	s1,a1,1
  state = 0;
    1016:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    1018:	02500a13          	li	s4,37
      if(c == 'd'){
    101c:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    1020:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    1024:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    1028:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    102c:	00000b97          	auipc	s7,0x0
    1030:	4bcb8b93          	addi	s7,s7,1212 # 14e8 <digits>
    1034:	a839                	j	1052 <vprintf+0x6a>
        putc(fd, c);
    1036:	85ca                	mv	a1,s2
    1038:	8556                	mv	a0,s5
    103a:	00000097          	auipc	ra,0x0
    103e:	ee2080e7          	jalr	-286(ra) # f1c <putc>
    1042:	a019                	j	1048 <vprintf+0x60>
    } else if(state == '%'){
    1044:	01498f63          	beq	s3,s4,1062 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    1048:	0485                	addi	s1,s1,1
    104a:	fff4c903          	lbu	s2,-1(s1)
    104e:	14090d63          	beqz	s2,11a8 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    1052:	0009079b          	sext.w	a5,s2
    if(state == 0){
    1056:	fe0997e3          	bnez	s3,1044 <vprintf+0x5c>
      if(c == '%'){
    105a:	fd479ee3          	bne	a5,s4,1036 <vprintf+0x4e>
        state = '%';
    105e:	89be                	mv	s3,a5
    1060:	b7e5                	j	1048 <vprintf+0x60>
      if(c == 'd'){
    1062:	05878063          	beq	a5,s8,10a2 <vprintf+0xba>
      } else if(c == 'l') {
    1066:	05978c63          	beq	a5,s9,10be <vprintf+0xd6>
      } else if(c == 'x') {
    106a:	07a78863          	beq	a5,s10,10da <vprintf+0xf2>
      } else if(c == 'p') {
    106e:	09b78463          	beq	a5,s11,10f6 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    1072:	07300713          	li	a4,115
    1076:	0ce78663          	beq	a5,a4,1142 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    107a:	06300713          	li	a4,99
    107e:	0ee78e63          	beq	a5,a4,117a <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    1082:	11478863          	beq	a5,s4,1192 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    108e:	e92080e7          	jalr	-366(ra) # f1c <putc>
        putc(fd, c);
    1092:	85ca                	mv	a1,s2
    1094:	8556                	mv	a0,s5
    1096:	00000097          	auipc	ra,0x0
    109a:	e86080e7          	jalr	-378(ra) # f1c <putc>
      }
      state = 0;
    109e:	4981                	li	s3,0
    10a0:	b765                	j	1048 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    10b4:	e8e080e7          	jalr	-370(ra) # f3e <printint>
    10b8:	8b4a                	mv	s6,s2
      state = 0;
    10ba:	4981                	li	s3,0
    10bc:	b771                	j	1048 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    10d0:	e72080e7          	jalr	-398(ra) # f3e <printint>
    10d4:	8b4a                	mv	s6,s2
      state = 0;
    10d6:	4981                	li	s3,0
    10d8:	bf85                	j	1048 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    10ec:	e56080e7          	jalr	-426(ra) # f3e <printint>
    10f0:	8b4a                	mv	s6,s2
      state = 0;
    10f2:	4981                	li	s3,0
    10f4:	bf91                	j	1048 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    10f6:	008b0793          	addi	a5,s6,8
    10fa:	f8f43423          	sd	a5,-120(s0)
    10fe:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    1102:	03000593          	li	a1,48
    1106:	8556                	mv	a0,s5
    1108:	00000097          	auipc	ra,0x0
    110c:	e14080e7          	jalr	-492(ra) # f1c <putc>
  putc(fd, 'x');
    1110:	85ea                	mv	a1,s10
    1112:	8556                	mv	a0,s5
    1114:	00000097          	auipc	ra,0x0
    1118:	e08080e7          	jalr	-504(ra) # f1c <putc>
    111c:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    111e:	03c9d793          	srli	a5,s3,0x3c
    1122:	97de                	add	a5,a5,s7
    1124:	0007c583          	lbu	a1,0(a5)
    1128:	8556                	mv	a0,s5
    112a:	00000097          	auipc	ra,0x0
    112e:	df2080e7          	jalr	-526(ra) # f1c <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1132:	0992                	slli	s3,s3,0x4
    1134:	397d                	addiw	s2,s2,-1
    1136:	fe0914e3          	bnez	s2,111e <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    113a:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    113e:	4981                	li	s3,0
    1140:	b721                	j	1048 <vprintf+0x60>
        s = va_arg(ap, char*);
    1142:	008b0993          	addi	s3,s6,8
    1146:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    114a:	02090163          	beqz	s2,116c <vprintf+0x184>
        while(*s != 0){
    114e:	00094583          	lbu	a1,0(s2)
    1152:	c9a1                	beqz	a1,11a2 <vprintf+0x1ba>
          putc(fd, *s);
    1154:	8556                	mv	a0,s5
    ...
    1164:	f9e5                	bnez	a1,1154 <vprintf+0x16c>
        s = va_arg(ap, char*);
    1166:	8b4e                	mv	s6,s3
      state = 0;
    1168:	4981                	li	s3,0
    116a:	bdf9                	j	1048 <vprintf+0x60>
          s = "(null)";
    116c:	00000917          	auipc	s2,0x0
    1170:	37490913          	addi	s2,s2,884 # 14e0 <malloc+0x22e>
        while(*s != 0){
    1174:	02800593          	li	a1,40
    1178:	bff1                	j	1154 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    ...
    119a:	d86080e7          	jalr	-634(ra) # f1c <putc>
      state = 0;
    119e:	4981                	li	s3,0
    11a0:	b565                	j	1048 <vprintf+0x60>
        s = va_arg(ap, char*);
    11a2:	8b4e                	mv	s6,s3
      state = 0;
    11a4:	4981                	li	s3,0
    11a6:	b54d                	j	1048 <vprintf+0x60>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    11e8:	e04080e7          	jalr	-508(ra) # fe8 <vprintf>
}
...
printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    ...
    121e:	dce080e7          	jalr	-562(ra) # fe8 <vprintf>
}
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1238:	2dc7b783          	ld	a5,732(a5) # 1510 <freep>
    123c:	a805                	j	126c <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    123e:	4618                	lw	a4,8(a2)
    1240:	9db9                	addw	a1,a1,a4
    1242:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1246:	6398                	ld	a4,0(a5)
    1248:	6318                	ld	a4,0(a4)
    124a:	fee53823          	sd	a4,-16(a0)
    124e:	a091                	j	1292 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    1250:	ff852703          	lw	a4,-8(a0)
    1254:	9e39                	addw	a2,a2,a4
    1256:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    1258:	ff053703          	ld	a4,-16(a0)
    125c:	e398                	sd	a4,0(a5)
    125e:	a099                	j	12a4 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1260:	6398                	ld	a4,0(a5)
    1262:	00e7e463          	bltu	a5,a4,126a <free+0x40>
    1266:	00e6ea63          	bltu	a3,a4,127a <free+0x50>
{
    126a:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    126c:	fed7fae3          	bgeu	a5,a3,1260 <free+0x36>
    1270:	6398                	ld	a4,0(a5)
    1272:	00e6e463          	bltu	a3,a4,127a <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1276:	fee7eae3          	bltu	a5,a4,126a <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    127a:	ff852583          	lw	a1,-8(a0)
    127e:	6390                	ld	a2,0(a5)
    1280:	02059813          	slli	a6,a1,0x20
    1284:	01c85713          	srli	a4,a6,0x1c
    1288:	9736                	add	a4,a4,a3
    128a:	fae60ae3          	beq	a2,a4,123e <free+0x14>
    bp->s.ptr = p->s.ptr;
    128e:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    1292:	4790                	lw	a2,8(a5)
    1294:	02061593          	slli	a1,a2,0x20
    1298:	01c5d713          	srli	a4,a1,0x1c
    129c:	973e                	add	a4,a4,a5
    129e:	fae689e3          	beq	a3,a4,1250 <free+0x26>
  } else
    p->s.ptr = bp;
    12a2:	e394                	sd	a3,0(a5)
  freep = p;
    12a4:	00000717          	auipc	a4,0x0
    12a8:	26f73623          	sd	a5,620(a4) # 1510 <freep>
}
    12ac:	6422                	ld	s0,8(sp)
    12ae:	0141                	addi	sp,sp,16
    12b0:	8082                	ret

00000000000012b2 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    12be:	e852                	sd	s4,16(sp)
    12c0:	e456                	sd	s5,8(sp)
    12c2:	e05a                	sd	s6,0(sp)
    12c4:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    12c6:	02051493          	slli	s1,a0,0x20
    12ca:	9081                	srli	s1,s1,0x20
    12cc:	04bd                	addi	s1,s1,15
    12ce:	8091                	srli	s1,s1,0x4
    12d0:	0014899b          	addiw	s3,s1,1
    12d4:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    12d6:	00000517          	auipc	a0,0x0
    12da:	23a53503          	ld	a0,570(a0) # 1510 <freep>
    12de:	c515                	beqz	a0,130a <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    12e4:	02977f63          	bgeu	a4,s1,1322 <malloc+0x70>
    12e8:	8a4e                	mv	s4,s3
    12ea:	0009871b          	sext.w	a4,s3
    12ee:	6685                	lui	a3,0x1
    12f0:	00d77363          	bgeu	a4,a3,12f6 <malloc+0x44>
    12f4:	6a05                	lui	s4,0x1
    12f6:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    12fa:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    12fe:	00000917          	auipc	s2,0x0
    1302:	21290913          	addi	s2,s2,530 # 1510 <freep>
  if(p == (char*)-1)
    1306:	5afd                	li	s5,-1
    1308:	a895                	j	137c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    130a:	00000797          	auipc	a5,0x0
    130e:	27678793          	addi	a5,a5,630 # 1580 <base>
    1312:	00000717          	auipc	a4,0x0
    1316:	1ef73f23          	sd	a5,510(a4) # 1510 <freep>
    131a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    131c:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    1320:	b7e1                	j	12e8 <malloc+0x36>
      if(p->s.size == nunits)
    1322:	02e48c63          	beq	s1,a4,135a <malloc+0xa8>
        p->s.size -= nunits;
    1326:	4137073b          	subw	a4,a4,s3
    132a:	c798                	sw	a4,8(a5)
        p += p->s.size;
    132c:	02071693          	slli	a3,a4,0x20
    1330:	01c6d713          	srli	a4,a3,0x1c
    1334:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    1336:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    133a:	00000717          	auipc	a4,0x0
    133e:	1ca73b23          	sd	a0,470(a4) # 1510 <freep>
      return (void*)(p + 1);
    ...
    135e:	bff1                	j	133a <malloc+0x88>
  hp->s.size = nu;
    1360:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    1364:	0541                	addi	a0,a0,16
    1366:	00000097          	auipc	ra,0x0
    136a:	ec4080e7          	jalr	-316(ra) # 122a <free>
  return freep;
    136e:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    1372:	d971                	beqz	a0,1346 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1374:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1376:	4798                	lw	a4,8(a5)
    1378:	fa9775e3          	bgeu	a4,s1,1322 <malloc+0x70>
    if(p == freep)
    137c:	00093703          	ld	a4,0(s2)
    1380:	853e                	mv	a0,a5
    1382:	fef719e3          	bne	a4,a5,1374 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    1386:	8552                	mv	a0,s4
    1388:	00000097          	auipc	ra,0x0
    138c:	b64080e7          	jalr	-1180(ra) # eec <sbrk>
  if(p == (char*)-1)
    1390:	fd5518e3          	bne	a0,s5,1360 <malloc+0xae>
        return 0;
    1394:	4501                	li	a0,0
    1396:	bf45                	j	1346 <malloc+0x94>
