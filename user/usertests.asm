...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	eba50513          	addi	a0,a0,-326 # 5ef8 <malloc+0x41a>
      46:	00006097          	auipc	ra,0x6
      4a:	9da080e7          	jalr	-1574(ra) # 5a20 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	e9850513          	addi	a0,a0,-360 # 5f18 <malloc+0x43a>
      88:	00006097          	auipc	ra,0x6
      8c:	998080e7          	jalr	-1640(ra) # 5a20 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	e8850513          	addi	a0,a0,-376 # 5f30 <malloc+0x452>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	e8a50513          	addi	a0,a0,-374 # 5f50 <malloc+0x472>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	e5250513          	addi	a0,a0,-430 # 5f38 <malloc+0x45a>
      ee:	00006097          	auipc	ra,0x6
      f2:	932080e7          	jalr	-1742(ra) # 5a20 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	e5e50513          	addi	a0,a0,-418 # 5f60 <malloc+0x482>
     10a:	00006097          	auipc	ra,0x6
     10e:	916080e7          	jalr	-1770(ra) # 5a20 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	e5c50513          	addi	a0,a0,-420 # 5f88 <malloc+0x4aa>
     134:	00005097          	auipc	ra,0x5
     138:	5bc080e7          	jalr	1468(ra) # 56f0 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	e4850513          	addi	a0,a0,-440 # 5f88 <malloc+0x4aa>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	e4458593          	addi	a1,a1,-444 # 5f98 <malloc+0x4ba>
     15c:	00005097          	auipc	ra,0x5
     160:	564080e7          	jalr	1380(ra) # 56c0 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	e2050513          	addi	a0,a0,-480 # 5f88 <malloc+0x4aa>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	e2458593          	addi	a1,a1,-476 # 5fa0 <malloc+0x4c2>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	df450513          	addi	a0,a0,-524 # 5f88 <malloc+0x4aa>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	dde50513          	addi	a0,a0,-546 # 5fa8 <malloc+0x4ca>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	84e080e7          	jalr	-1970(ra) # 5a20 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	b1c50513          	addi	a0,a0,-1252 # 5d98 <malloc+0x2ba>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	b08a8a93          	addi	s5,s5,-1272 # 5d98 <malloc+0x2ba>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	cbe50513          	addi	a0,a0,-834 # 5fd0 <malloc+0x4f2>
     31a:	00005097          	auipc	ra,0x5
     31e:	706080e7          	jalr	1798(ra) # 5a20 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	cba50513          	addi	a0,a0,-838 # 5ff0 <malloc+0x512>
     33e:	00005097          	auipc	ra,0x5
     342:	6e2080e7          	jalr	1762(ra) # 5a20 <printf>
        exit(1);
     346:	4505                	li	a0,1
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	c96a0a13          	addi	s4,s4,-874 # 6008 <malloc+0x52a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	bf250513          	addi	a0,a0,-1038 # 6010 <malloc+0x532>
     426:	00005097          	auipc	ra,0x5
     42a:	5fa080e7          	jalr	1530(ra) # 5a20 <printf>
      exit(1);
     42e:	4505                	li	a0,1
     ...
     440:	bec50513          	addi	a0,a0,-1044 # 6028 <malloc+0x54a>
     444:	00005097          	auipc	ra,0x5
     448:	5dc080e7          	jalr	1500(ra) # 5a20 <printf>
      exit(1);
     44c:	4505                	li	a0,1
     ...
     45e:	bfe50513          	addi	a0,a0,-1026 # 6058 <malloc+0x57a>
     462:	00005097          	auipc	ra,0x5
     466:	5be080e7          	jalr	1470(ra) # 5a20 <printf>
      exit(1);
     46a:	4505                	li	a0,1
     ...
     478:	c1450513          	addi	a0,a0,-1004 # 6088 <malloc+0x5aa>
     47c:	00005097          	auipc	ra,0x5
     480:	5a4080e7          	jalr	1444(ra) # 5a20 <printf>
      exit(1);
     484:	4505                	li	a0,1
     ...
     496:	c0650513          	addi	a0,a0,-1018 # 6098 <malloc+0x5ba>
     49a:	00005097          	auipc	ra,0x5
     49e:	586080e7          	jalr	1414(ra) # 5a20 <printf>
      exit(1);
     4a2:	4505                	li	a0,1
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	bf8a0a13          	addi	s4,s4,-1032 # 60c8 <malloc+0x5ea>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	ac8a8a93          	addi	s5,s5,-1336 # 5fa0 <malloc+0x4c2>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	b5250513          	addi	a0,a0,-1198 # 60d0 <malloc+0x5f2>
     586:	00005097          	auipc	ra,0x5
     58a:	49a080e7          	jalr	1178(ra) # 5a20 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     5a0:	b4c50513          	addi	a0,a0,-1204 # 60e8 <malloc+0x60a>
     5a4:	00005097          	auipc	ra,0x5
     5a8:	47c080e7          	jalr	1148(ra) # 5a20 <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	ad250513          	addi	a0,a0,-1326 # 6088 <malloc+0x5aa>
     5be:	00005097          	auipc	ra,0x5
     5c2:	462080e7          	jalr	1122(ra) # 5a20 <printf>
      exit(1);
     5c6:	4505                	li	a0,1
     ...
     5d4:	b4850513          	addi	a0,a0,-1208 # 6118 <malloc+0x63a>
     5d8:	00005097          	auipc	ra,0x5
     5dc:	448080e7          	jalr	1096(ra) # 5a20 <printf>
      exit(1);
     5e0:	4505                	li	a0,1
     ...
     5f2:	b4250513          	addi	a0,a0,-1214 # 6130 <malloc+0x652>
     5f6:	00005097          	auipc	ra,0x5
     5fa:	42a080e7          	jalr	1066(ra) # 5a20 <printf>
      exit(1);
     5fe:	4505                	li	a0,1
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	95458593          	addi	a1,a1,-1708 # 5f98 <malloc+0x4ba>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	92850513          	addi	a0,a0,-1752 # 5f88 <malloc+0x4aa>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	8fc50513          	addi	a0,a0,-1796 # 5f88 <malloc+0x4aa>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	8e850513          	addi	a0,a0,-1816 # 5f88 <malloc+0x4aa>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	ae258593          	addi	a1,a1,-1310 # 61c0 <malloc+0x6e2>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	86850513          	addi	a0,a0,-1944 # 5f88 <malloc+0x4aa>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	9fc50513          	addi	a0,a0,-1540 # 6160 <malloc+0x682>
     76c:	00005097          	auipc	ra,0x5
     770:	2b4080e7          	jalr	692(ra) # 5a20 <printf>
    exit(1);
     774:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	a0050513          	addi	a0,a0,-1536 # 6180 <malloc+0x6a2>
     788:	00005097          	auipc	ra,0x5
     78c:	298080e7          	jalr	664(ra) # 5a20 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     790:	8652                	mv	a2,s4
     792:	85d6                	mv	a1,s5
     794:	00006517          	auipc	a0,0x6
     798:	9fc50513          	addi	a0,a0,-1540 # 6190 <malloc+0x6b2>
     79c:	00005097          	auipc	ra,0x5
     7a0:	284080e7          	jalr	644(ra) # 5a20 <printf>
    exit(1);
     7a4:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	a0050513          	addi	a0,a0,-1536 # 61b0 <malloc+0x6d2>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	268080e7          	jalr	616(ra) # 5a20 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7c0:	8652                	mv	a2,s4
     7c2:	85d6                	mv	a1,s5
     7c4:	00006517          	auipc	a0,0x6
     7c8:	9cc50513          	addi	a0,a0,-1588 # 6190 <malloc+0x6b2>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	254080e7          	jalr	596(ra) # 5a20 <printf>
    exit(1);
     7d4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	9e650513          	addi	a0,a0,-1562 # 61c8 <malloc+0x6ea>
     7ea:	00005097          	auipc	ra,0x5
     7ee:	236080e7          	jalr	566(ra) # 5a20 <printf>
    exit(1);
     7f2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	9e850513          	addi	a0,a0,-1560 # 61e8 <malloc+0x70a>
     808:	00005097          	auipc	ra,0x5
     80c:	218080e7          	jalr	536(ra) # 5a20 <printf>
    exit(1);
     810:	4505                	li	a0,1
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	9d450513          	addi	a0,a0,-1580 # 6208 <malloc+0x72a>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	9e498993          	addi	s3,s3,-1564 # 6230 <malloc+0x752>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	a14a8a93          	addi	s5,s5,-1516 # 6268 <malloc+0x78a>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	96e50513          	addi	a0,a0,-1682 # 6208 <malloc+0x72a>
  ...
  if(unlink("small") < 0){
     ...
     8da:	93250513          	addi	a0,a0,-1742 # 6208 <malloc+0x72a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	91050513          	addi	a0,a0,-1776 # 6210 <malloc+0x732>
     908:	00005097          	auipc	ra,0x5
     90c:	118080e7          	jalr	280(ra) # 5a20 <printf>
    exit(1);
     910:	4505                	li	a0,1
     ...
     922:	92250513          	addi	a0,a0,-1758 # 6240 <malloc+0x762>
     926:	00005097          	auipc	ra,0x5
     92a:	0fa080e7          	jalr	250(ra) # 5a20 <printf>
      exit(1);
     92e:	4505                	li	a0,1
     ...
     940:	93c50513          	addi	a0,a0,-1732 # 6278 <malloc+0x79a>
     944:	00005097          	auipc	ra,0x5
     948:	0dc080e7          	jalr	220(ra) # 5a20 <printf>
      exit(1);
     94c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	94850513          	addi	a0,a0,-1720 # 62a0 <malloc+0x7c2>
     960:	00005097          	auipc	ra,0x5
     964:	0c0080e7          	jalr	192(ra) # 5a20 <printf>
    exit(1);
     968:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     978:	94c50513          	addi	a0,a0,-1716 # 62c0 <malloc+0x7e2>
     97c:	00005097          	auipc	ra,0x5
     980:	0a4080e7          	jalr	164(ra) # 5a20 <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	94850513          	addi	a0,a0,-1720 # 62d8 <malloc+0x7fa>
     998:	00005097          	auipc	ra,0x5
     99c:	088080e7          	jalr	136(ra) # 5a20 <printf>
    exit(1);
     9a0:	4505                	li	a0,1
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	93650513          	addi	a0,a0,-1738 # 62f8 <malloc+0x81a>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9da:	1a290913          	addi	s2,s2,418 # bb78 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	8e450513          	addi	a0,a0,-1820 # 62f8 <malloc+0x81a>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2c:	15090913          	addi	s2,s2,336 # bb78 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	8a450513          	addi	a0,a0,-1884 # 6300 <malloc+0x822>
     a64:	00005097          	auipc	ra,0x5
     a68:	fbc080e7          	jalr	-68(ra) # 5a20 <printf>
    exit(1);
     a6c:	4505                	li	a0,1
     ...
     a7e:	8a650513          	addi	a0,a0,-1882 # 6320 <malloc+0x842>
     a82:	00005097          	auipc	ra,0x5
     a86:	f9e080e7          	jalr	-98(ra) # 5a20 <printf>
      exit(1);
     a8a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	8b250513          	addi	a0,a0,-1870 # 6348 <malloc+0x86a>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	f82080e7          	jalr	-126(ra) # 5a20 <printf>
    exit(1);
     aa6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac6:	83650513          	addi	a0,a0,-1994 # 62f8 <malloc+0x81a>
     ...
     af2:	87a50513          	addi	a0,a0,-1926 # 6368 <malloc+0x88a>
     af6:	00005097          	auipc	ra,0x5
     afa:	f2a080e7          	jalr	-214(ra) # 5a20 <printf>
        exit(1);
     afe:	4505                	li	a0,1
     ...
     b10:	88450513          	addi	a0,a0,-1916 # 6390 <malloc+0x8b2>
     b14:	00005097          	auipc	ra,0x5
     b18:	f0c080e7          	jalr	-244(ra) # 5a20 <printf>
      exit(1);
     b1c:	4505                	li	a0,1
     ...
     b2e:	87e50513          	addi	a0,a0,-1922 # 63a8 <malloc+0x8ca>
     b32:	00005097          	auipc	ra,0x5
     b36:	eee080e7          	jalr	-274(ra) # 5a20 <printf>
      exit(1);
     b3a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	88a50513          	addi	a0,a0,-1910 # 63d0 <malloc+0x8f2>
     b4e:	00005097          	auipc	ra,0x5
     b52:	ed2080e7          	jalr	-302(ra) # 5a20 <printf>
    exit(1);
     b56:	4505                	li	a0,1
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	1b450513          	addi	a0,a0,436 # 5d28 <malloc+0x24a>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	87c58593          	addi	a1,a1,-1924 # 6408 <malloc+0x92a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	18050513          	addi	a0,a0,384 # 5d28 <malloc+0x24a>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	16a50513          	addi	a0,a0,362 # 5d28 <malloc+0x24a>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	15450513          	addi	a0,a0,340 # 5d28 <malloc+0x24a>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	86858593          	addi	a1,a1,-1944 # 6450 <malloc+0x972>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c08:	f7458593          	addi	a1,a1,-140 # bb78 <buf>
     c0c:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c54:	0d850513          	addi	a0,a0,216 # 5d28 <malloc+0x24a>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	77850513          	addi	a0,a0,1912 # 63e8 <malloc+0x90a>
     c78:	00005097          	auipc	ra,0x5
     c7c:	da8080e7          	jalr	-600(ra) # 5a20 <printf>
    exit(1);
     c80:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	78450513          	addi	a0,a0,1924 # 6410 <malloc+0x932>
     c94:	00005097          	auipc	ra,0x5
     c98:	d8c080e7          	jalr	-628(ra) # 5a20 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	78850513          	addi	a0,a0,1928 # 6430 <malloc+0x952>
     cb0:	00005097          	auipc	ra,0x5
     cb4:	d70080e7          	jalr	-656(ra) # 5a20 <printf>
    exit(1);
     cb8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	79450513          	addi	a0,a0,1940 # 6458 <malloc+0x97a>
     ccc:	00005097          	auipc	ra,0x5
     cd0:	d54080e7          	jalr	-684(ra) # 5a20 <printf>
    exit(1);
     cd4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	79850513          	addi	a0,a0,1944 # 6478 <malloc+0x99a>
     ce8:	00005097          	auipc	ra,0x5
     cec:	d38080e7          	jalr	-712(ra) # 5a20 <printf>
    exit(1);
     cf0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	79c50513          	addi	a0,a0,1948 # 6498 <malloc+0x9ba>
     d04:	00005097          	auipc	ra,0x5
     d08:	d1c080e7          	jalr	-740(ra) # 5a20 <printf>
    exit(1);
     d0c:	4505                	li	a0,1
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	6a858593          	addi	a1,a1,1704 # 6408 <malloc+0x92a>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	74058593          	addi	a1,a1,1856 # 64c0 <malloc+0x9e2>
     d88:	00005517          	auipc	a0,0x5
     d8c:	73050513          	addi	a0,a0,1840 # 64b8 <malloc+0x9da>
  ...
  unlink("lf1");
     ...
     da0:	71c50513          	addi	a0,a0,1820 # 64b8 <malloc+0x9da>
     da4:	00005097          	auipc	ra,0x5
     da8:	94c080e7          	jalr	-1716(ra) # 56f0 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00005517          	auipc	a0,0x5
     db2:	70a50513          	addi	a0,a0,1802 # 64b8 <malloc+0x9da>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	6fc50513          	addi	a0,a0,1788 # 64c0 <malloc+0x9e2>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de0:	d9c58593          	addi	a1,a1,-612 # bb78 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	6c458593          	addi	a1,a1,1732 # 64c0 <malloc+0x9e2>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	6ae50513          	addi	a0,a0,1710 # 64c0 <malloc+0x9e2>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	8d6080e7          	jalr	-1834(ra) # 56f0 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00005597          	auipc	a1,0x5
     e26:	69658593          	addi	a1,a1,1686 # 64b8 <malloc+0x9da>
     e2a:	00005517          	auipc	a0,0x5
     e2e:	69650513          	addi	a0,a0,1686 # 64c0 <malloc+0x9e2>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	67a58593          	addi	a1,a1,1658 # 64b8 <malloc+0x9da>
     e46:	00005517          	auipc	a0,0x5
     e4a:	78250513          	addi	a0,a0,1922 # 65c8 <malloc+0xaea>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	66050513          	addi	a0,a0,1632 # 64c8 <malloc+0x9ea>
     e70:	00005097          	auipc	ra,0x5
     e74:	bb0080e7          	jalr	-1104(ra) # 5a20 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	65c50513          	addi	a0,a0,1628 # 64e0 <malloc+0xa02>
     e8c:	00005097          	auipc	ra,0x5
     e90:	b94080e7          	jalr	-1132(ra) # 5a20 <printf>
    exit(1);
     e94:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	65850513          	addi	a0,a0,1624 # 64f8 <malloc+0xa1a>
     ea8:	00005097          	auipc	ra,0x5
     eac:	b78080e7          	jalr	-1160(ra) # 5a20 <printf>
    exit(1);
     eb0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	65c50513          	addi	a0,a0,1628 # 6518 <malloc+0xa3a>
     ec4:	00005097          	auipc	ra,0x5
     ec8:	b5c080e7          	jalr	-1188(ra) # 5a20 <printf>
    exit(1);
     ecc:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	67050513          	addi	a0,a0,1648 # 6548 <malloc+0xa6a>
     ee0:	00005097          	auipc	ra,0x5
     ee4:	b40080e7          	jalr	-1216(ra) # 5a20 <printf>
    exit(1);
     ee8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	66c50513          	addi	a0,a0,1644 # 6560 <malloc+0xa82>
     efc:	00005097          	auipc	ra,0x5
     f00:	b24080e7          	jalr	-1244(ra) # 5a20 <printf>
    exit(1);
     f04:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	66850513          	addi	a0,a0,1640 # 6578 <malloc+0xa9a>
     f18:	00005097          	auipc	ra,0x5
     f1c:	b08080e7          	jalr	-1272(ra) # 5a20 <printf>
    exit(1);
     f20:	4505                	li	a0,1
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f30:	67450513          	addi	a0,a0,1652 # 65a0 <malloc+0xac2>
     f34:	00005097          	auipc	ra,0x5
     f38:	aec080e7          	jalr	-1300(ra) # 5a20 <printf>
    exit(1);
     f3c:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	68850513          	addi	a0,a0,1672 # 65d0 <malloc+0xaf2>
     f50:	00005097          	auipc	ra,0x5
     f54:	ad0080e7          	jalr	-1328(ra) # 5a20 <printf>
    exit(1);
     f58:	4505                	li	a0,1
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	642a0a13          	addi	s4,s4,1602 # 65f0 <malloc+0xb12>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	5f050513          	addi	a0,a0,1520 # 65f0 <malloc+0xb12>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	58850513          	addi	a0,a0,1416 # 65f8 <malloc+0xb1a>
    1078:	00005097          	auipc	ra,0x5
    107c:	9a8080e7          	jalr	-1624(ra) # 5a20 <printf>
    exit(1);
    1080:	4505                	li	a0,1
    ...
    1094:	58850513          	addi	a0,a0,1416 # 6618 <malloc+0xb3a>
    1098:	00005097          	auipc	ra,0x5
    109c:	988080e7          	jalr	-1656(ra) # 5a20 <printf>
      exit(1);
    10a0:	4505                	li	a0,1
    ...
    10b0:	58c50513          	addi	a0,a0,1420 # 6638 <malloc+0xb5a>
    10b4:	00005097          	auipc	ra,0x5
    10b8:	96c080e7          	jalr	-1684(ra) # 5a20 <printf>
      exit(1);
    10bc:	4505                	li	a0,1
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	57a98993          	addi	s3,s3,1402 # 6658 <malloc+0xb7a>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	54e50513          	addi	a0,a0,1358 # 6668 <malloc+0xb8a>
    1122:	00005097          	auipc	ra,0x5
    1126:	8fe080e7          	jalr	-1794(ra) # 5a20 <printf>
      exit(1);
    112a:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1146:	2064b483          	ld	s1,518(s1) # 8348 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117c:	35048493          	addi	s1,s1,848 # c350 <buf+0x7d8>
  for(int i = 0; i < 50000; i++){
    ...
    118a:	daa98993          	addi	s3,s3,-598 # 5f30 <malloc+0x452>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	62878793          	addi	a5,a5,1576 # 7838 <malloc+0x1d5a>
  ...
  if(pid == 0){
    ...
    124a:	21a78793          	addi	a5,a5,538 # 8460 <big.0>
    124e:	00008697          	auipc	a3,0x8
    1252:	21268693          	addi	a3,a3,530 # 9460 <__global_pointer$+0x918>
      big[i] = 'x';
    ...
    1268:	1e078e23          	sb	zero,508(a5) # 9460 <__global_pointer$+0x918>
    char *args2[] = { big, big, big, 0 };
    126c:	00007797          	auipc	a5,0x7
    1270:	cdc78793          	addi	a5,a5,-804 # 7f48 <malloc+0x246a>
    ...
    1294:	ca050513          	addi	a0,a0,-864 # 5f30 <malloc+0x452>
    ...
    12ac:	46850513          	addi	a0,a0,1128 # 6710 <malloc+0xc32>
    12b0:	00004097          	auipc	ra,0x4
    12b4:	770080e7          	jalr	1904(ra) # 5a20 <printf>
      exit(1);
    12b8:	4505                	li	a0,1
    ...
    12cc:	3c050513          	addi	a0,a0,960 # 6688 <malloc+0xbaa>
    12d0:	00004097          	auipc	ra,0x4
    12d4:	750080e7          	jalr	1872(ra) # 5a20 <printf>
    exit(1);
    12d8:	4505                	li	a0,1
    ...
    12ec:	3c050513          	addi	a0,a0,960 # 66a8 <malloc+0xbca>
    12f0:	00004097          	auipc	ra,0x4
    12f4:	730080e7          	jalr	1840(ra) # 5a20 <printf>
    exit(1);
    12f8:	4505                	li	a0,1
    ...
    130e:	3be50513          	addi	a0,a0,958 # 66c8 <malloc+0xbea>
    1312:	00004097          	auipc	ra,0x4
    1316:	70e080e7          	jalr	1806(ra) # 5a20 <printf>
    exit(1);
    131a:	4505                	li	a0,1
    ...
    132e:	3c650513          	addi	a0,a0,966 # 66f0 <malloc+0xc12>
    1332:	00004097          	auipc	ra,0x4
    1336:	6ee080e7          	jalr	1774(ra) # 5a20 <printf>
    exit(1);
    133a:	4505                	li	a0,1
    ...
    1348:	82c50513          	addi	a0,a0,-2004 # 6b70 <malloc+0x1092>
    134c:	00004097          	auipc	ra,0x4
    1350:	6d4080e7          	jalr	1748(ra) # 5a20 <printf>
    exit(1);
    1354:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1392:	3aa50513          	addi	a0,a0,938 # 6738 <malloc+0xc5a>
    1396:	00004097          	auipc	ra,0x4
    139a:	68a080e7          	jalr	1674(ra) # 5a20 <printf>
    exit(1);
    139e:	4505                	li	a0,1
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	bc850513          	addi	a0,a0,-1080 # 5f88 <malloc+0x4aa>
  ...
  if(pid == 0){
    ...
    13ee:	b9ea0a13          	addi	s4,s4,-1122 # 5f88 <malloc+0x4aa>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	3a6a8a93          	addi	s5,s5,934 # 6798 <malloc+0xcba>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	30650513          	addi	a0,a0,774 # 6768 <malloc+0xc8a>
    146a:	00004097          	auipc	ra,0x4
    146e:	5b6080e7          	jalr	1462(ra) # 5a20 <printf>
    exit(1);
    1472:	4505                	li	a0,1
    ...
    1482:	30250513          	addi	a0,a0,770 # 6780 <malloc+0xca2>
    1486:	00004097          	auipc	ra,0x4
    148a:	59a080e7          	jalr	1434(ra) # 5a20 <printf>
        exit(1);
    148e:	4505                	li	a0,1
    ...
    14a0:	30c50513          	addi	a0,a0,780 # 67a8 <malloc+0xcca>
    14a4:	00004097          	auipc	ra,0x4
    14a8:	57c080e7          	jalr	1404(ra) # 5a20 <printf>
        exit(1);
    14ac:	4505                	li	a0,1
    ...
    14be:	acea0a13          	addi	s4,s4,-1330 # 5f88 <malloc+0x4aa>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	306a8a93          	addi	s5,s5,774 # 67c8 <malloc+0xcea>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	a7c50513          	addi	a0,a0,-1412 # 5f88 <malloc+0x4aa>
  ...
  exit(xstatus);
    ...
    152e:	25650513          	addi	a0,a0,598 # 6780 <malloc+0xca2>
    1532:	00004097          	auipc	ra,0x4
    1536:	4ee080e7          	jalr	1262(ra) # 5a20 <printf>
      exit(1);
    153a:	4505                	li	a0,1
    ...
    154c:	28850513          	addi	a0,a0,648 # 67d0 <malloc+0xcf2>
    1550:	00004097          	auipc	ra,0x4
    1554:	4d0080e7          	jalr	1232(ra) # 5a20 <printf>
      exit(1);
    1558:	4505                	li	a0,1
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	9c078793          	addi	a5,a5,-1600 # 5f30 <malloc+0x452>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	27478793          	addi	a5,a5,628 # 67f0 <malloc+0xd12>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	26c50513          	addi	a0,a0,620 # 67f8 <malloc+0xd1a>
  ...
  if(pid == 0) {
    ...
    15be:	23e50513          	addi	a0,a0,574 # 67f8 <malloc+0xd1a>
    ...
    15da:	24250513          	addi	a0,a0,578 # 6818 <malloc+0xd3a>
    15de:	00004097          	auipc	ra,0x4
    15e2:	442080e7          	jalr	1090(ra) # 5a20 <printf>
      exit(1);
    15e6:	4505                	li	a0,1
    ...
    15f6:	17650513          	addi	a0,a0,374 # 6768 <malloc+0xc8a>
    15fa:	00004097          	auipc	ra,0x4
    15fe:	426080e7          	jalr	1062(ra) # 5a20 <printf>
     exit(1);
    1602:	4505                	li	a0,1
    ...
    1612:	1f250513          	addi	a0,a0,498 # 6800 <malloc+0xd22>
    1616:	00004097          	auipc	ra,0x4
    161a:	40a080e7          	jalr	1034(ra) # 5a20 <printf>
      exit(1);
    161e:	4505                	li	a0,1
    ...
    1630:	90450513          	addi	a0,a0,-1788 # 5f30 <malloc+0x452>
  ...
  if(xstatus != 0)
    ...
    1664:	1c850513          	addi	a0,a0,456 # 6828 <malloc+0xd4a>
    1668:	00004097          	auipc	ra,0x4
    166c:	3b8080e7          	jalr	952(ra) # 5a20 <printf>
      exit(1);
    1670:	4505                	li	a0,1
    ...
    1680:	1c450513          	addi	a0,a0,452 # 6840 <malloc+0xd62>
    1684:	00004097          	auipc	ra,0x4
    1688:	39c080e7          	jalr	924(ra) # 5a20 <printf>
    168c:	b7d1                	j	1650 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168e:	4581                	li	a1,0
    1690:	00005517          	auipc	a0,0x5
    1694:	16850513          	addi	a0,a0,360 # 67f8 <malloc+0xd1a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	c0650513          	addi	a0,a0,-1018 # 62c0 <malloc+0x7e2>
    16c2:	00004097          	auipc	ra,0x4
    16c6:	35e080e7          	jalr	862(ra) # 5a20 <printf>
    exit(1);
    16ca:	4505                	li	a0,1
    ...
    16da:	0aa50513          	addi	a0,a0,170 # 6780 <malloc+0xca2>
    16de:	00004097          	auipc	ra,0x4
    16e2:	342080e7          	jalr	834(ra) # 5a20 <printf>
    exit(1);
    16e6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f4:	10850513          	addi	a0,a0,264 # 67f8 <malloc+0xd1a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	13e50513          	addi	a0,a0,318 # 6858 <malloc+0xd7a>
    1722:	00004097          	auipc	ra,0x4
    1726:	2fe080e7          	jalr	766(ra) # 5a20 <printf>
    exit(1);
    172a:	4505                	li	a0,1
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    178a:	3f2a8a93          	addi	s5,s5,1010 # bb78 <buf>
      if(cc > sizeof(buf))
    ...
    17a8:	3d470713          	addi	a4,a4,980 # bb78 <buf>
    ...
    17e0:	09450513          	addi	a0,a0,148 # 6870 <malloc+0xd92>
    17e4:	00004097          	auipc	ra,0x4
    17e8:	23c080e7          	jalr	572(ra) # 5a20 <printf>
    exit(1);
    17ec:	4505                	li	a0,1
    ...
    1806:	376b0b13          	addi	s6,s6,886 # bb78 <buf>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	02650513          	addi	a0,a0,38 # 6888 <malloc+0xdaa>
    186a:	00004097          	auipc	ra,0x4
    186e:	1b6080e7          	jalr	438(ra) # 5a20 <printf>
        exit(1);
    1872:	4505                	li	a0,1
    ...
    1882:	02250513          	addi	a0,a0,34 # 68a0 <malloc+0xdc2>
    1886:	00004097          	auipc	ra,0x4
    188a:	19a080e7          	jalr	410(ra) # 5a20 <printf>
}
    ...
    18b4:	00850513          	addi	a0,a0,8 # 68b8 <malloc+0xdda>
    18b8:	00004097          	auipc	ra,0x4
    18bc:	168080e7          	jalr	360(ra) # 5a20 <printf>
      exit(1);
    18c0:	4505                	li	a0,1
    ...
    18f4:	fe850513          	addi	a0,a0,-24 # 68d8 <malloc+0xdfa>
    18f8:	00004097          	auipc	ra,0x4
    18fc:	128080e7          	jalr	296(ra) # 5a20 <printf>
    exit(1);
    1900:	4505                	li	a0,1
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	e0650513          	addi	a0,a0,-506 # 6768 <malloc+0xc8a>
    196a:	00004097          	auipc	ra,0x4
    196e:	0b6080e7          	jalr	182(ra) # 5a20 <printf>
      exit(1);
    1972:	4505                	li	a0,1
    ...
    1982:	f7250513          	addi	a0,a0,-142 # 68f0 <malloc+0xe12>
    1986:	00004097          	auipc	ra,0x4
    198a:	09a080e7          	jalr	154(ra) # 5a20 <printf>
        exit(1);
    198e:	4505                	li	a0,1
    ...
    199e:	f6e50513          	addi	a0,a0,-146 # 6908 <malloc+0xe2a>
    19a2:	00004097          	auipc	ra,0x4
    19a6:	07e080e7          	jalr	126(ra) # 5a20 <printf>
        exit(1);
    19aa:	4505                	li	a0,1
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	d5650513          	addi	a0,a0,-682 # 6768 <malloc+0xc8a>
    1a1a:	00004097          	auipc	ra,0x4
    1a1e:	006080e7          	jalr	6(ra) # 5a20 <printf>
      exit(1);
    1a22:	4505                	li	a0,1
    ...
    1a3a:	d3250513          	addi	a0,a0,-718 # 6768 <malloc+0xc8a>
    1a3e:	00004097          	auipc	ra,0x4
    1a42:	fe2080e7          	jalr	-30(ra) # 5a20 <printf>
        exit(1);
    1a46:	4505                	li	a0,1
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	e7850513          	addi	a0,a0,-392 # 6928 <malloc+0xe4a>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	f68080e7          	jalr	-152(ra) # 5a20 <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1ac6:	bde080e7          	jalr	-1058(ra) # 56a0 <exit>
{
    ...
    1b0c:	e3050513          	addi	a0,a0,-464 # 6938 <malloc+0xe5a>
    1b10:	00004097          	auipc	ra,0x4
    1b14:	f10080e7          	jalr	-240(ra) # 5a20 <printf>
      exit(1);
    1b18:	4505                	li	a0,1
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	01a50513          	addi	a0,a0,26 # 6b70 <malloc+0x1092>
    1b5e:	00004097          	auipc	ra,0x4
    1b62:	ec2080e7          	jalr	-318(ra) # 5a20 <printf>
      exit(1);
    1b66:	4505                	li	a0,1
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	f7c50513          	addi	a0,a0,-132 # 6b70 <malloc+0x1092>
    1bfc:	00004097          	auipc	ra,0x4
    1c00:	e24080e7          	jalr	-476(ra) # 5a20 <printf>
      exit(1);
    1c04:	4505                	li	a0,1
    ...
    1c24:	be050513          	addi	a0,a0,-1056 # 6800 <malloc+0xd22>
    1c28:	00004097          	auipc	ra,0x4
    1c2c:	df8080e7          	jalr	-520(ra) # 5a20 <printf>
          exit(1);
    1c30:	4505                	li	a0,1
    ...
    1c96:	cc650513          	addi	a0,a0,-826 # 6958 <malloc+0xe7a>
    1c9a:	00004097          	auipc	ra,0x4
    1c9e:	d86080e7          	jalr	-634(ra) # 5a20 <printf>
            exit(1);
    1ca2:	4505                	li	a0,1
    ...
    1cca:	caa50513          	addi	a0,a0,-854 # 6970 <malloc+0xe92>
    1cce:	00004097          	auipc	ra,0x4
    1cd2:	d52080e7          	jalr	-686(ra) # 5a20 <printf>
        exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1d30:	c6c50513          	addi	a0,a0,-916 # 6998 <malloc+0xeba>
    1d34:	00004097          	auipc	ra,0x4
    1d38:	cec080e7          	jalr	-788(ra) # 5a20 <printf>
        exit(1);
    1d3c:	4505                	li	a0,1
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	1d450513          	addi	a0,a0,468 # 5fa0 <malloc+0x4c2>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	198a8a93          	addi	s5,s5,408 # 5fa0 <malloc+0x4c2>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	bb0b8b93          	addi	s7,s7,-1104 # 69c0 <malloc+0xee2>
    1e18:	a825                	j	1e50 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	94c50513          	addi	a0,a0,-1716 # 6768 <malloc+0xc8a>
    1e24:	00004097          	auipc	ra,0x4
    1e28:	bfc080e7          	jalr	-1028(ra) # 5a20 <printf>
    exit(1);
    1e2c:	4505                	li	a0,1
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	c6650513          	addi	a0,a0,-922 # 6b70 <malloc+0x1092>
    1f12:	00004097          	auipc	ra,0x4
    1f16:	b0e080e7          	jalr	-1266(ra) # 5a20 <printf>
      exit(1);
    1f1a:	4505                	li	a0,1
    ...
    1f4a:	c32b0b13          	addi	s6,s6,-974 # bb78 <buf>
    ...
    1fbe:	a0e50513          	addi	a0,a0,-1522 # 69c8 <malloc+0xeea>
    1fc2:	00004097          	auipc	ra,0x4
    1fc6:	a5e080e7          	jalr	-1442(ra) # 5a20 <printf>
            exit(1);
    1fca:	4505                	li	a0,1
    ...
    1fde:	01650513          	addi	a0,a0,22 # 5ff0 <malloc+0x512>
    1fe2:	00004097          	auipc	ra,0x4
    1fe6:	a3e080e7          	jalr	-1474(ra) # 5a20 <printf>
            exit(1);
    1fea:	4505                	li	a0,1
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	9d050513          	addi	a0,a0,-1584 # 69f8 <malloc+0xf1a>
    2030:	00004097          	auipc	ra,0x4
    2034:	9f0080e7          	jalr	-1552(ra) # 5a20 <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208e:	95650513          	addi	a0,a0,-1706 # 69e0 <malloc+0xf02>
    2092:	00004097          	auipc	ra,0x4
    2096:	98e080e7          	jalr	-1650(ra) # 5a20 <printf>
    exit(1);
    209a:	4505                	li	a0,1
    ...
    20aa:	97a50513          	addi	a0,a0,-1670 # 6a20 <malloc+0xf42>
    20ae:	00004097          	auipc	ra,0x4
    20b2:	972080e7          	jalr	-1678(ra) # 5a20 <printf>
      exit(1);
    20b6:	4505                	li	a0,1
    ...
    20c6:	97650513          	addi	a0,a0,-1674 # 6a38 <malloc+0xf5a>
    20ca:	00004097          	auipc	ra,0x4
    20ce:	956080e7          	jalr	-1706(ra) # 5a20 <printf>
    exit(1);
    20d2:	4505                	li	a0,1
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f8:	35098993          	addi	s3,s3,848 # c350 <buf+0x7d8>
    20fc:	1003d937          	lui	s2,0x1003d
    2100:	090e                	slli	s2,s2,0x3
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e8f8>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	62650513          	addi	a0,a0,1574 # 6768 <malloc+0xc8a>
    214a:	00004097          	auipc	ra,0x4
    214e:	8d6080e7          	jalr	-1834(ra) # 5a20 <printf>
      exit(1);
    2152:	4505                	li	a0,1
    ...
    2168:	8ec50513          	addi	a0,a0,-1812 # 6a50 <malloc+0xf72>
    216c:	00004097          	auipc	ra,0x4
    2170:	8b4080e7          	jalr	-1868(ra) # 5a20 <printf>
      exit(1);
    2174:	4505                	li	a0,1
...
0000000000002188 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2198:	8dc50513          	addi	a0,a0,-1828 # 6a70 <malloc+0xf92>
  ...
  fd = open("bigarg-ok", 0);
    ...
    21ca:	8aa50513          	addi	a0,a0,-1878 # 6a70 <malloc+0xf92>
  ...
  close(fd);
    ...
    21f0:	17478793          	addi	a5,a5,372 # 8360 <args.1>
    21f4:	00006697          	auipc	a3,0x6
    21f8:	26468693          	addi	a3,a3,612 # 8458 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    21fc:	00005717          	auipc	a4,0x5
    2200:	88470713          	addi	a4,a4,-1916 # 6a80 <malloc+0xfa2>
    ...
    2254:	91050513          	addi	a0,a0,-1776 # 6b60 <malloc+0x1082>
    2258:	00003097          	auipc	ra,0x3
    225c:	7c8080e7          	jalr	1992(ra) # 5a20 <printf>
    exit(1);
    2260:	4505                	li	a0,1
    ...
    2278:	90c50513          	addi	a0,a0,-1780 # 6b80 <malloc+0x10a2>
    227c:	00003097          	auipc	ra,0x3
    2280:	7a4080e7          	jalr	1956(ra) # 5a20 <printf>
    exit(1);
    2284:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    22cc:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0478>
    22d0:	85a6                	mv	a1,s1
    22d2:	00005517          	auipc	a0,0x5
    22d6:	8ce50513          	addi	a0,a0,-1842 # 6ba0 <malloc+0x10c2>
    22da:	00003097          	auipc	ra,0x3
    22de:	746080e7          	jalr	1862(ra) # 5a20 <printf>
    exit(1);
    22e2:	4505                	li	a0,1
    ...
    22f2:	47a50513          	addi	a0,a0,1146 # 6768 <malloc+0xc8a>
    22f6:	00003097          	auipc	ra,0x3
    22fa:	72a080e7          	jalr	1834(ra) # 5a20 <printf>
    exit(1);
    22fe:	4505                	li	a0,1
...
0000000000002312 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    238c:	4b078793          	addi	a5,a5,1200 # 7838 <malloc+0x1d5a>
  ...
  if(ret != -1){
    ...
    23ce:	7fe50513          	addi	a0,a0,2046 # 6bc8 <malloc+0x10ea>
    23d2:	00003097          	auipc	ra,0x3
    23d6:	64e080e7          	jalr	1614(ra) # 5a20 <printf>
    exit(1);
    23da:	4505                	li	a0,1
    ...
    23ec:	2a050513          	addi	a0,a0,672 # 6688 <malloc+0xbaa>
    23f0:	00003097          	auipc	ra,0x3
    23f4:	630080e7          	jalr	1584(ra) # 5a20 <printf>
    exit(1);
    23f8:	4505                	li	a0,1
    ...
    240a:	2a250513          	addi	a0,a0,674 # 66a8 <malloc+0xbca>
    240e:	00003097          	auipc	ra,0x3
    2412:	612080e7          	jalr	1554(ra) # 5a20 <printf>
    exit(1);
    2416:	4505                	li	a0,1
    ...
    242a:	2a250513          	addi	a0,a0,674 # 66c8 <malloc+0xbea>
    242e:	00003097          	auipc	ra,0x3
    2432:	5f2080e7          	jalr	1522(ra) # 5a20 <printf>
    exit(1);
    2436:	4505                	li	a0,1
    ...
    2448:	2ac50513          	addi	a0,a0,684 # 66f0 <malloc+0xc12>
    244c:	00003097          	auipc	ra,0x3
    2450:	5d4080e7          	jalr	1492(ra) # 5a20 <printf>
    exit(1);
    2454:	4505                	li	a0,1
...
000000000000245e <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2494:	7b050513          	addi	a0,a0,1968 # 5c40 <malloc+0x162>
  ...
  if(n >= 0){
    ...
    24c6:	75e50513          	addi	a0,a0,1886 # 6c20 <malloc+0x1142>
    24ca:	00003097          	auipc	ra,0x3
    24ce:	556080e7          	jalr	1366(ra) # 5a20 <printf>
    exit(1);
    24d2:	4505                	li	a0,1
    ...
    24e0:	6f450513          	addi	a0,a0,1780 # 6bd0 <malloc+0x10f2>
    24e4:	00003097          	auipc	ra,0x3
    24e8:	53c080e7          	jalr	1340(ra) # 5a20 <printf>
    exit(1);
    24ec:	4505                	li	a0,1
    ...
    24fa:	6f250513          	addi	a0,a0,1778 # 6be8 <malloc+0x110a>
    24fe:	00003097          	auipc	ra,0x3
    2502:	522080e7          	jalr	1314(ra) # 5a20 <printf>
    exit(1);
    2506:	4505                	li	a0,1
    ...
    2514:	6f850513          	addi	a0,a0,1784 # 6c08 <malloc+0x112a>
    2518:	00003097          	auipc	ra,0x3
    251c:	508080e7          	jalr	1288(ra) # 5a20 <printf>
    exit(1);
    2520:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2538:	70c50513          	addi	a0,a0,1804 # 5c40 <malloc+0x162>
    253c:	00003097          	auipc	ra,0x3
    2540:	1b4080e7          	jalr	436(ra) # 56f0 <unlink>
  fd = open("README", O_RDONLY);
    2544:	4581                	li	a1,0
    2546:	00004517          	auipc	a0,0x4
    254a:	b8250513          	addi	a0,a0,-1150 # 60c8 <malloc+0x5ea>
  ...
  if(n >= 0){
    ...
    2574:	6e050513          	addi	a0,a0,1760 # 6c50 <malloc+0x1172>
    2578:	00003097          	auipc	ra,0x3
    257c:	4a8080e7          	jalr	1192(ra) # 5a20 <printf>
    exit(1);
    2580:	4505                	li	a0,1
    ...
    258e:	67e50513          	addi	a0,a0,1662 # 6c08 <malloc+0x112a>
    2592:	00003097          	auipc	ra,0x3
    2596:	48e080e7          	jalr	1166(ra) # 5a20 <printf>
    exit(1);
    259a:	4505                	li	a0,1
...
00000000000025b8 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    25f4:	6705                	lui	a4,0x1
      *b = 99;
    25f6:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1478>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    260e:	66e50513          	addi	a0,a0,1646 # 6c78 <malloc+0x119a>
    2612:	00003097          	auipc	ra,0x3
    2616:	40e080e7          	jalr	1038(ra) # 5a20 <printf>
    exit(1);
    261a:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2660:	63c50513          	addi	a0,a0,1596 # 6c98 <malloc+0x11ba>
    2664:	00003097          	auipc	ra,0x3
    2668:	3bc080e7          	jalr	956(ra) # 5a20 <printf>
    exit(1);
    266c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    26c4:	63850513          	addi	a0,a0,1592 # 6cf8 <malloc+0x121a>
    26c8:	00003097          	auipc	ra,0x3
    26cc:	358080e7          	jalr	856(ra) # 5a20 <printf>
    exit(1);
    26d0:	4505                	li	a0,1
    ...
    26e4:	5d850513          	addi	a0,a0,1496 # 6cb8 <malloc+0x11da>
    26e8:	00003097          	auipc	ra,0x3
    26ec:	338080e7          	jalr	824(ra) # 5a20 <printf>
      exit(1);
    26f0:	4505                	li	a0,1
    ...
    2700:	5dc50513          	addi	a0,a0,1500 # 6cd8 <malloc+0x11fa>
    2704:	00003097          	auipc	ra,0x3
    2708:	31c080e7          	jalr	796(ra) # 5a20 <printf>
    exit(1);
    270c:	4505                	li	a0,1
...
000000000000273c <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    279e:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1477>
  a = sbrk(0);
    27a2:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2802:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1477>
  ...
  if(c != a){
    ...
    284a:	4d250513          	addi	a0,a0,1234 # 6d18 <malloc+0x123a>
    284e:	00003097          	auipc	ra,0x3
    2852:	1d2080e7          	jalr	466(ra) # 5a20 <printf>
    exit(1);
    2856:	4505                	li	a0,1
    ...
    2866:	4fe50513          	addi	a0,a0,1278 # 6d60 <malloc+0x1282>
    286a:	00003097          	auipc	ra,0x3
    286e:	1b6080e7          	jalr	438(ra) # 5a20 <printf>
    exit(1);
    2872:	4505                	li	a0,1
    ...
    2886:	4fe50513          	addi	a0,a0,1278 # 6d80 <malloc+0x12a2>
    288a:	00003097          	auipc	ra,0x3
    288e:	196080e7          	jalr	406(ra) # 5a20 <printf>
    exit(1);
    2892:	4505                	li	a0,1
    ...
    28a6:	51e50513          	addi	a0,a0,1310 # 6dc0 <malloc+0x12e2>
    28aa:	00003097          	auipc	ra,0x3
    28ae:	176080e7          	jalr	374(ra) # 5a20 <printf>
    exit(1);
    28b2:	4505                	li	a0,1
    ...
    28c2:	53250513          	addi	a0,a0,1330 # 6df0 <malloc+0x1312>
    28c6:	00003097          	auipc	ra,0x3
    28ca:	15a080e7          	jalr	346(ra) # 5a20 <printf>
    exit(1);
    28ce:	4505                	li	a0,1
    ...
    28e2:	54a50513          	addi	a0,a0,1354 # 6e28 <malloc+0x134a>
    28e6:	00003097          	auipc	ra,0x3
    28ea:	13a080e7          	jalr	314(ra) # 5a20 <printf>
    exit(1);
    28ee:	4505                	li	a0,1
...
00000000000028f8 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    291c:	53850513          	addi	a0,a0,1336 # 6e50 <malloc+0x1372>
    2920:	00003097          	auipc	ra,0x3
    2924:	dc0080e7          	jalr	-576(ra) # 56e0 <open>
    2928:	84aa                	mv	s1,a0
  unlink("sbrk");
    292a:	00004517          	auipc	a0,0x4
    292e:	52650513          	addi	a0,a0,1318 # 6e50 <malloc+0x1372>
  ...
  if(pipe((int *) a) != 0){
    ...
    2982:	4da50513          	addi	a0,a0,1242 # 6e58 <malloc+0x137a>
    2986:	00003097          	auipc	ra,0x3
    298a:	09a080e7          	jalr	154(ra) # 5a20 <printf>
    exit(1);
    298e:	4505                	li	a0,1
    ...
    299e:	4d650513          	addi	a0,a0,1238 # 6e70 <malloc+0x1392>
    29a2:	00003097          	auipc	ra,0x3
    29a6:	07e080e7          	jalr	126(ra) # 5a20 <printf>
    exit(1);
    29aa:	4505                	li	a0,1
    ...
    29ba:	eba50513          	addi	a0,a0,-326 # 6870 <malloc+0xd92>
    29be:	00003097          	auipc	ra,0x3
    29c2:	062080e7          	jalr	98(ra) # 5a20 <printf>
    exit(1);
    29c6:	4505                	li	a0,1
...
00000000000029d0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    29e4:	4a850513          	addi	a0,a0,1192 # 6e88 <malloc+0x13aa>
  ...
  close(fd);
    ...
    2a2c:	d5850513          	addi	a0,a0,-680 # 6780 <malloc+0xca2>
    2a30:	00003097          	auipc	ra,0x3
    2a34:	ff0080e7          	jalr	-16(ra) # 5a20 <printf>
    exit(1);
    2a38:	4505                	li	a0,1
...
0000000000002a42 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2a7a:	0fa50513          	addi	a0,a0,250 # 6b70 <malloc+0x1092>
    2a7e:	00003097          	auipc	ra,0x3
    2a82:	fa2080e7          	jalr	-94(ra) # 5a20 <printf>
    exit(1);
    2a86:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2ad0:	0a450513          	addi	a0,a0,164 # 6b70 <malloc+0x1092>
    2ad4:	00003097          	auipc	ra,0x3
    2ad8:	f4c080e7          	jalr	-180(ra) # 5a20 <printf>
    exit(1);
    2adc:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b30:	04450513          	addi	a0,a0,68 # 6b70 <malloc+0x1092>
    2b34:	00003097          	auipc	ra,0x3
    2b38:	eec080e7          	jalr	-276(ra) # 5a20 <printf>
    exit(1);
    2b3c:	4505                	li	a0,1
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2b9c:	fd850513          	addi	a0,a0,-40 # 6b70 <malloc+0x1092>
    2ba0:	00003097          	auipc	ra,0x3
    2ba4:	e80080e7          	jalr	-384(ra) # 5a20 <printf>
      exit(1);
    2ba8:	4505                	li	a0,1
    ...
    2bf0:	34450513          	addi	a0,a0,836 # 5f30 <malloc+0x452>
    2bf4:	faa43c23          	sd	a0,-72(s0)
    2bf8:	00003797          	auipc	a5,0x3
    2bfc:	3a878793          	addi	a5,a5,936 # 5fa0 <malloc+0x4c2>
...
0000000000002c1e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2c2e:	43650513          	addi	a0,a0,1078 # 7060 <malloc+0x1582>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2c40:	27c50513          	addi	a0,a0,636 # 6eb8 <malloc+0x13da>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2c56:	2be50513          	addi	a0,a0,702 # 6f10 <malloc+0x1432>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2c74:	31850513          	addi	a0,a0,792 # 6f88 <malloc+0x14aa>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2c90:	36c50513          	addi	a0,a0,876 # 6ff8 <malloc+0x151a>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2ca2:	3b250513          	addi	a0,a0,946 # 7050 <malloc+0x1572>
  ...
  unlink("12345678901234");
    ...
    2d20:	17450513          	addi	a0,a0,372 # 6e90 <malloc+0x13b2>
    2d24:	00003097          	auipc	ra,0x3
    2d28:	cfc080e7          	jalr	-772(ra) # 5a20 <printf>
    exit(1);
    2d2c:	4505                	li	a0,1
    ...
    2d3c:	1a050513          	addi	a0,a0,416 # 6ed8 <malloc+0x13fa>
    2d40:	00003097          	auipc	ra,0x3
    2d44:	ce0080e7          	jalr	-800(ra) # 5a20 <printf>
    exit(1);
    2d48:	4505                	li	a0,1
    ...
    2d58:	1ec50513          	addi	a0,a0,492 # 6f40 <malloc+0x1462>
    2d5c:	00003097          	auipc	ra,0x3
    2d60:	cc4080e7          	jalr	-828(ra) # 5a20 <printf>
    exit(1);
    2d64:	4505                	li	a0,1
    ...
    2d74:	24850513          	addi	a0,a0,584 # 6fb8 <malloc+0x14da>
    2d78:	00003097          	auipc	ra,0x3
    2d7c:	ca8080e7          	jalr	-856(ra) # 5a20 <printf>
    exit(1);
    2d80:	4505                	li	a0,1
    ...
    2d90:	28c50513          	addi	a0,a0,652 # 7018 <malloc+0x153a>
    2d94:	00003097          	auipc	ra,0x3
    2d98:	c8c080e7          	jalr	-884(ra) # 5a20 <printf>
    exit(1);
    2d9c:	4505                	li	a0,1
    ...
    2dac:	2c850513          	addi	a0,a0,712 # 7070 <malloc+0x1592>
    2db0:	00003097          	auipc	ra,0x3
    2db4:	c70080e7          	jalr	-912(ra) # 5a20 <printf>
    exit(1);
    2db8:	4505                	li	a0,1
...
0000000000002dc2 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2dd2:	2da50513          	addi	a0,a0,730 # 70a8 <malloc+0x15ca>
  ...
  if(chdir("iputdir") < 0){
    ...
    2de6:	2c650513          	addi	a0,a0,710 # 70a8 <malloc+0x15ca>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2dfa:	2f250513          	addi	a0,a0,754 # 70e8 <malloc+0x160a>
  ...
  if(chdir("/") < 0){
    ...
    2e0e:	30e50513          	addi	a0,a0,782 # 7118 <malloc+0x163a>
    ...
    2e2e:	28650513          	addi	a0,a0,646 # 70b0 <malloc+0x15d2>
    2e32:	00003097          	auipc	ra,0x3
    2e36:	bee080e7          	jalr	-1042(ra) # 5a20 <printf>
    exit(1);
    2e3a:	4505                	li	a0,1
    ...
    2e4a:	28250513          	addi	a0,a0,642 # 70c8 <malloc+0x15ea>
    2e4e:	00003097          	auipc	ra,0x3
    2e52:	bd2080e7          	jalr	-1070(ra) # 5a20 <printf>
    exit(1);
    2e56:	4505                	li	a0,1
    ...
    2e66:	29650513          	addi	a0,a0,662 # 70f8 <malloc+0x161a>
    2e6a:	00003097          	auipc	ra,0x3
    2e6e:	bb6080e7          	jalr	-1098(ra) # 5a20 <printf>
    exit(1);
    2e72:	4505                	li	a0,1
    ...
    2e82:	2a250513          	addi	a0,a0,674 # 7120 <malloc+0x1642>
    2e86:	00003097          	auipc	ra,0x3
    2e8a:	b9a080e7          	jalr	-1126(ra) # 5a20 <printf>
    exit(1);
    2e8e:	4505                	li	a0,1
...
0000000000002e98 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2eb6:	1f650513          	addi	a0,a0,502 # 70a8 <malloc+0x15ca>
    ...
    2eca:	1e250513          	addi	a0,a0,482 # 70a8 <malloc+0x15ca>
    ...
    2ede:	20e50513          	addi	a0,a0,526 # 70e8 <malloc+0x160a>
    ...
    2efe:	86e50513          	addi	a0,a0,-1938 # 6768 <malloc+0xc8a>
    2f02:	00003097          	auipc	ra,0x3
    2f06:	b1e080e7          	jalr	-1250(ra) # 5a20 <printf>
    exit(1);
    2f0a:	4505                	li	a0,1
    ...
    2f1a:	19a50513          	addi	a0,a0,410 # 70b0 <malloc+0x15d2>
    2f1e:	00003097          	auipc	ra,0x3
    2f22:	b02080e7          	jalr	-1278(ra) # 5a20 <printf>
      exit(1);
    2f26:	4505                	li	a0,1
    ...
    2f36:	20650513          	addi	a0,a0,518 # 7138 <malloc+0x165a>
    2f3a:	00003097          	auipc	ra,0x3
    2f3e:	ae6080e7          	jalr	-1306(ra) # 5a20 <printf>
      exit(1);
    2f42:	4505                	li	a0,1
    ...
    2f52:	1aa50513          	addi	a0,a0,426 # 70f8 <malloc+0x161a>
    2f56:	00003097          	auipc	ra,0x3
    2f5a:	aca080e7          	jalr	-1334(ra) # 5a20 <printf>
      exit(1);
    2f5e:	4505                	li	a0,1
...
0000000000002f80 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2f90:	1c450513          	addi	a0,a0,452 # 7150 <malloc+0x1672>
  ...
  if(chdir("dir0") < 0){
    ...
    2fa4:	1b050513          	addi	a0,a0,432 # 7150 <malloc+0x1672>
  ...
  if(chdir("..") < 0){
    ...
    2fb8:	1bc50513          	addi	a0,a0,444 # 7170 <malloc+0x1692>
  ...
  if(unlink("dir0") < 0){
    ...
    2fcc:	18850513          	addi	a0,a0,392 # 7150 <malloc+0x1672>
    ...
    2fec:	0c850513          	addi	a0,a0,200 # 70b0 <malloc+0x15d2>
    2ff0:	00003097          	auipc	ra,0x3
    2ff4:	a30080e7          	jalr	-1488(ra) # 5a20 <printf>
    exit(1);
    2ff8:	4505                	li	a0,1
    ...
    3008:	15450513          	addi	a0,a0,340 # 7158 <malloc+0x167a>
    300c:	00003097          	auipc	ra,0x3
    3010:	a14080e7          	jalr	-1516(ra) # 5a20 <printf>
    exit(1);
    3014:	4505                	li	a0,1
    ...
    3024:	15850513          	addi	a0,a0,344 # 7178 <malloc+0x169a>
    3028:	00003097          	auipc	ra,0x3
    302c:	9f8080e7          	jalr	-1544(ra) # 5a20 <printf>
    exit(1);
    3030:	4505                	li	a0,1
    ...
    3040:	15450513          	addi	a0,a0,340 # 7190 <malloc+0x16b2>
    3044:	00003097          	auipc	ra,0x3
    3048:	9dc080e7          	jalr	-1572(ra) # 5a20 <printf>
    exit(1);
    304c:	4505                	li	a0,1
...
0000000000003056 <subdir>:
{
  ...
  unlink("ff");
    ...
    3068:	27450513          	addi	a0,a0,628 # 72d8 <malloc+0x17fa>
    306c:	00002097          	auipc	ra,0x2
    3070:	684080e7          	jalr	1668(ra) # 56f0 <unlink>
  if(mkdir("dd") != 0){
    3074:	00004517          	auipc	a0,0x4
    3078:	13450513          	addi	a0,a0,308 # 71a8 <malloc+0x16ca>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3090:	13c50513          	addi	a0,a0,316 # 71c8 <malloc+0x16ea>
  ...
  write(fd, "ff", 2);
    ...
    30a8:	23458593          	addi	a1,a1,564 # 72d8 <malloc+0x17fa>
  ...
  if(unlink("dd") >= 0){
    ...
    30c2:	0ea50513          	addi	a0,a0,234 # 71a8 <malloc+0x16ca>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    30d6:	14e50513          	addi	a0,a0,334 # 7220 <malloc+0x1742>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    30ee:	15e50513          	addi	a0,a0,350 # 7248 <malloc+0x176a>
  ...
  write(fd, "FF", 2);
    ...
    3106:	17658593          	addi	a1,a1,374 # 7278 <malloc+0x179a>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3122:	16250513          	addi	a0,a0,354 # 7280 <malloc+0x17a2>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    313a:	a4258593          	addi	a1,a1,-1470 # bb78 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3150:	a2c74703          	lbu	a4,-1492(a4) # bb78 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    316a:	16a58593          	addi	a1,a1,362 # 72d0 <malloc+0x17f2>
    316e:	00004517          	auipc	a0,0x4
    3172:	0da50513          	addi	a0,a0,218 # 7248 <malloc+0x176a>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3186:	0c650513          	addi	a0,a0,198 # 7248 <malloc+0x176a>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    319c:	0b050513          	addi	a0,a0,176 # 7248 <malloc+0x176a>
  ...
  if(chdir("dd") != 0){
    ...
    31b0:	ffc50513          	addi	a0,a0,-4 # 71a8 <malloc+0x16ca>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    31c4:	1a850513          	addi	a0,a0,424 # 7368 <malloc+0x188a>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    31d8:	1c450513          	addi	a0,a0,452 # 7398 <malloc+0x18ba>
  ...
  if(chdir("./..") != 0){
    ...
    31ec:	1e050513          	addi	a0,a0,480 # 73c8 <malloc+0x18ea>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3202:	0d250513          	addi	a0,a0,210 # 72d0 <malloc+0x17f2>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    321a:	96258593          	addi	a1,a1,-1694 # bb78 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    323c:	01050513          	addi	a0,a0,16 # 7248 <malloc+0x176a>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3254:	20850513          	addi	a0,a0,520 # 7458 <malloc+0x197a>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    326c:	22050513          	addi	a0,a0,544 # 7488 <malloc+0x19aa>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3284:	f2850513          	addi	a0,a0,-216 # 71a8 <malloc+0x16ca>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    329a:	f1250513          	addi	a0,a0,-238 # 71a8 <malloc+0x16ca>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    32b0:	efc50513          	addi	a0,a0,-260 # 71a8 <malloc+0x16ca>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    32c4:	25858593          	addi	a1,a1,600 # 7518 <malloc+0x1a3a>
    32c8:	00004517          	auipc	a0,0x4
    32cc:	19050513          	addi	a0,a0,400 # 7458 <malloc+0x197a>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    32e0:	23c58593          	addi	a1,a1,572 # 7518 <malloc+0x1a3a>
    32e4:	00004517          	auipc	a0,0x4
    32e8:	1a450513          	addi	a0,a0,420 # 7488 <malloc+0x19aa>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    32fc:	fd858593          	addi	a1,a1,-40 # 72d0 <malloc+0x17f2>
    3300:	00004517          	auipc	a0,0x4
    3304:	ec850513          	addi	a0,a0,-312 # 71c8 <malloc+0x16ea>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3318:	14450513          	addi	a0,a0,324 # 7458 <malloc+0x197a>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    332c:	16050513          	addi	a0,a0,352 # 7488 <malloc+0x19aa>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3340:	f9450513          	addi	a0,a0,-108 # 72d0 <malloc+0x17f2>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3354:	13850513          	addi	a0,a0,312 # 7488 <malloc+0x19aa>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3368:	0f450513          	addi	a0,a0,244 # 7458 <malloc+0x197a>
  ...
  if(chdir("dd/ff") == 0){
    ...
    337c:	e5050513          	addi	a0,a0,-432 # 71c8 <malloc+0x16ea>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3390:	2dc50513          	addi	a0,a0,732 # 7668 <malloc+0x1b8a>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    33a4:	f3050513          	addi	a0,a0,-208 # 72d0 <malloc+0x17f2>
  ...
  if(unlink("dd/ff") != 0){
    ...
    33b8:	e1450513          	addi	a0,a0,-492 # 71c8 <malloc+0x16ea>
  ...
  if(unlink("dd") == 0){
    ...
    33cc:	de050513          	addi	a0,a0,-544 # 71a8 <malloc+0x16ca>
  ...
  if(unlink("dd/dd") < 0){
    ...
    33e0:	2fc50513          	addi	a0,a0,764 # 76d8 <malloc+0x1bfa>
  ...
  if(unlink("dd") < 0){
    ...
    33f4:	db850513          	addi	a0,a0,-584 # 71a8 <malloc+0x16ca>
    ...
    3416:	d9e50513          	addi	a0,a0,-610 # 71b0 <malloc+0x16d2>
    341a:	00002097          	auipc	ra,0x2
    341e:	606080e7          	jalr	1542(ra) # 5a20 <printf>
    exit(1);
    3422:	4505                	li	a0,1
    ...
    3432:	da250513          	addi	a0,a0,-606 # 71d0 <malloc+0x16f2>
    3436:	00002097          	auipc	ra,0x2
    343a:	5ea080e7          	jalr	1514(ra) # 5a20 <printf>
    exit(1);
    343e:	4505                	li	a0,1
    ...
    344e:	da650513          	addi	a0,a0,-602 # 71f0 <malloc+0x1712>
    3452:	00002097          	auipc	ra,0x2
    3456:	5ce080e7          	jalr	1486(ra) # 5a20 <printf>
    exit(1);
    345a:	4505                	li	a0,1
    ...
    346a:	dc250513          	addi	a0,a0,-574 # 7228 <malloc+0x174a>
    346e:	00002097          	auipc	ra,0x2
    3472:	5b2080e7          	jalr	1458(ra) # 5a20 <printf>
    exit(1);
    3476:	4505                	li	a0,1
    ...
    3486:	dd650513          	addi	a0,a0,-554 # 7258 <malloc+0x177a>
    348a:	00002097          	auipc	ra,0x2
    348e:	596080e7          	jalr	1430(ra) # 5a20 <printf>
    exit(1);
    3492:	4505                	li	a0,1
    ...
    34a2:	df250513          	addi	a0,a0,-526 # 7290 <malloc+0x17b2>
    34a6:	00002097          	auipc	ra,0x2
    34aa:	57a080e7          	jalr	1402(ra) # 5a20 <printf>
    exit(1);
    34ae:	4505                	li	a0,1
    ...
    34be:	df650513          	addi	a0,a0,-522 # 72b0 <malloc+0x17d2>
    34c2:	00002097          	auipc	ra,0x2
    34c6:	55e080e7          	jalr	1374(ra) # 5a20 <printf>
    exit(1);
    34ca:	4505                	li	a0,1
    ...
    34da:	e0a50513          	addi	a0,a0,-502 # 72e0 <malloc+0x1802>
    34de:	00002097          	auipc	ra,0x2
    34e2:	542080e7          	jalr	1346(ra) # 5a20 <printf>
    exit(1);
    34e6:	4505                	li	a0,1
    ...
    34f6:	e1650513          	addi	a0,a0,-490 # 7308 <malloc+0x182a>
    34fa:	00002097          	auipc	ra,0x2
    34fe:	526080e7          	jalr	1318(ra) # 5a20 <printf>
    exit(1);
    3502:	4505                	li	a0,1
    ...
    3512:	e1a50513          	addi	a0,a0,-486 # 7328 <malloc+0x184a>
    3516:	00002097          	auipc	ra,0x2
    351a:	50a080e7          	jalr	1290(ra) # 5a20 <printf>
    exit(1);
    351e:	4505                	li	a0,1
    ...
    352e:	e2650513          	addi	a0,a0,-474 # 7350 <malloc+0x1872>
    3532:	00002097          	auipc	ra,0x2
    3536:	4ee080e7          	jalr	1262(ra) # 5a20 <printf>
    exit(1);
    353a:	4505                	li	a0,1
    ...
    354a:	e3250513          	addi	a0,a0,-462 # 7378 <malloc+0x189a>
    354e:	00002097          	auipc	ra,0x2
    3552:	4d2080e7          	jalr	1234(ra) # 5a20 <printf>
    exit(1);
    3556:	4505                	li	a0,1
    ...
    3566:	e4650513          	addi	a0,a0,-442 # 73a8 <malloc+0x18ca>
    356a:	00002097          	auipc	ra,0x2
    356e:	4b6080e7          	jalr	1206(ra) # 5a20 <printf>
    exit(1);
    3572:	4505                	li	a0,1
    ...
    3582:	e5250513          	addi	a0,a0,-430 # 73d0 <malloc+0x18f2>
    3586:	00002097          	auipc	ra,0x2
    358a:	49a080e7          	jalr	1178(ra) # 5a20 <printf>
    exit(1);
    358e:	4505                	li	a0,1
    ...
    359e:	e4e50513          	addi	a0,a0,-434 # 73e8 <malloc+0x190a>
    35a2:	00002097          	auipc	ra,0x2
    35a6:	47e080e7          	jalr	1150(ra) # 5a20 <printf>
    exit(1);
    35aa:	4505                	li	a0,1
    ...
    35ba:	e5250513          	addi	a0,a0,-430 # 7408 <malloc+0x192a>
    35be:	00002097          	auipc	ra,0x2
    35c2:	462080e7          	jalr	1122(ra) # 5a20 <printf>
    exit(1);
    35c6:	4505                	li	a0,1
    ...
    35d6:	e5650513          	addi	a0,a0,-426 # 7428 <malloc+0x194a>
    35da:	00002097          	auipc	ra,0x2
    35de:	446080e7          	jalr	1094(ra) # 5a20 <printf>
    exit(1);
    35e2:	4505                	li	a0,1
    ...
    35f2:	e7a50513          	addi	a0,a0,-390 # 7468 <malloc+0x198a>
    35f6:	00002097          	auipc	ra,0x2
    35fa:	42a080e7          	jalr	1066(ra) # 5a20 <printf>
    exit(1);
    35fe:	4505                	li	a0,1
    ...
    360e:	e8e50513          	addi	a0,a0,-370 # 7498 <malloc+0x19ba>
    3612:	00002097          	auipc	ra,0x2
    3616:	40e080e7          	jalr	1038(ra) # 5a20 <printf>
    exit(1);
    361a:	4505                	li	a0,1
    ...
    362a:	e9250513          	addi	a0,a0,-366 # 74b8 <malloc+0x19da>
    362e:	00002097          	auipc	ra,0x2
    3632:	3f2080e7          	jalr	1010(ra) # 5a20 <printf>
    exit(1);
    3636:	4505                	li	a0,1
    ...
    3646:	e9650513          	addi	a0,a0,-362 # 74d8 <malloc+0x19fa>
    364a:	00002097          	auipc	ra,0x2
    364e:	3d6080e7          	jalr	982(ra) # 5a20 <printf>
    exit(1);
    3652:	4505                	li	a0,1
    ...
    3662:	e9a50513          	addi	a0,a0,-358 # 74f8 <malloc+0x1a1a>
    3666:	00002097          	auipc	ra,0x2
    366a:	3ba080e7          	jalr	954(ra) # 5a20 <printf>
    exit(1);
    366e:	4505                	li	a0,1
    ...
    367e:	eae50513          	addi	a0,a0,-338 # 7528 <malloc+0x1a4a>
    3682:	00002097          	auipc	ra,0x2
    3686:	39e080e7          	jalr	926(ra) # 5a20 <printf>
    exit(1);
    368a:	4505                	li	a0,1
    ...
    369a:	eba50513          	addi	a0,a0,-326 # 7550 <malloc+0x1a72>
    369e:	00002097          	auipc	ra,0x2
    36a2:	382080e7          	jalr	898(ra) # 5a20 <printf>
    exit(1);
    36a6:	4505                	li	a0,1
    ...
    36b6:	ec650513          	addi	a0,a0,-314 # 7578 <malloc+0x1a9a>
    36ba:	00002097          	auipc	ra,0x2
    36be:	366080e7          	jalr	870(ra) # 5a20 <printf>
    exit(1);
    36c2:	4505                	li	a0,1
    ...
    36d2:	ed250513          	addi	a0,a0,-302 # 75a0 <malloc+0x1ac2>
    36d6:	00002097          	auipc	ra,0x2
    36da:	34a080e7          	jalr	842(ra) # 5a20 <printf>
    exit(1);
    36de:	4505                	li	a0,1
    ...
    36ee:	ed650513          	addi	a0,a0,-298 # 75c0 <malloc+0x1ae2>
    36f2:	00002097          	auipc	ra,0x2
    36f6:	32e080e7          	jalr	814(ra) # 5a20 <printf>
    exit(1);
    36fa:	4505                	li	a0,1
    ...
    370a:	eda50513          	addi	a0,a0,-294 # 75e0 <malloc+0x1b02>
    370e:	00002097          	auipc	ra,0x2
    3712:	312080e7          	jalr	786(ra) # 5a20 <printf>
    exit(1);
    3716:	4505                	li	a0,1
    ...
    3726:	ee650513          	addi	a0,a0,-282 # 7608 <malloc+0x1b2a>
    372a:	00002097          	auipc	ra,0x2
    372e:	2f6080e7          	jalr	758(ra) # 5a20 <printf>
    exit(1);
    3732:	4505                	li	a0,1
    ...
    3742:	eea50513          	addi	a0,a0,-278 # 7628 <malloc+0x1b4a>
    3746:	00002097          	auipc	ra,0x2
    374a:	2da080e7          	jalr	730(ra) # 5a20 <printf>
    exit(1);
    374e:	4505                	li	a0,1
    ...
    375e:	eee50513          	addi	a0,a0,-274 # 7648 <malloc+0x1b6a>
    3762:	00002097          	auipc	ra,0x2
    3766:	2be080e7          	jalr	702(ra) # 5a20 <printf>
    exit(1);
    376a:	4505                	li	a0,1
    ...
    377a:	efa50513          	addi	a0,a0,-262 # 7670 <malloc+0x1b92>
    377e:	00002097          	auipc	ra,0x2
    3782:	2a2080e7          	jalr	674(ra) # 5a20 <printf>
    exit(1);
    3786:	4505                	li	a0,1
    ...
    3796:	b7650513          	addi	a0,a0,-1162 # 7308 <malloc+0x182a>
    379a:	00002097          	auipc	ra,0x2
    379e:	286080e7          	jalr	646(ra) # 5a20 <printf>
    exit(1);
    37a2:	4505                	li	a0,1
    ...
    37b2:	ee250513          	addi	a0,a0,-286 # 7690 <malloc+0x1bb2>
    37b6:	00002097          	auipc	ra,0x2
    37ba:	26a080e7          	jalr	618(ra) # 5a20 <printf>
    exit(1);
    37be:	4505                	li	a0,1
    ...
    37ce:	ee650513          	addi	a0,a0,-282 # 76b0 <malloc+0x1bd2>
    37d2:	00002097          	auipc	ra,0x2
    37d6:	24e080e7          	jalr	590(ra) # 5a20 <printf>
    exit(1);
    37da:	4505                	li	a0,1
    ...
    37ea:	efa50513          	addi	a0,a0,-262 # 76e0 <malloc+0x1c02>
    37ee:	00002097          	auipc	ra,0x2
    37f2:	232080e7          	jalr	562(ra) # 5a20 <printf>
    exit(1);
    37f6:	4505                	li	a0,1
    ...
    3806:	efe50513          	addi	a0,a0,-258 # 7700 <malloc+0x1c22>
    380a:	00002097          	auipc	ra,0x2
    380e:	216080e7          	jalr	534(ra) # 5a20 <printf>
    exit(1);
    3812:	4505                	li	a0,1
...
000000000000381c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    382c:	ef050513          	addi	a0,a0,-272 # 7718 <malloc+0x1c3a>
  ...
  if(chdir("dots") != 0){
    ...
    383e:	ede50513          	addi	a0,a0,-290 # 7718 <malloc+0x1c3a>
  ...
  if(unlink(".") == 0){
    ...
    3850:	d7c50513          	addi	a0,a0,-644 # 65c8 <malloc+0xaea>
  ...
  if(unlink("..") == 0){
    ...
    3862:	91250513          	addi	a0,a0,-1774 # 7170 <malloc+0x1692>
  ...
  if(chdir("/") != 0){
    ...
    3874:	8a850513          	addi	a0,a0,-1880 # 7118 <malloc+0x163a>
  ...
  if(unlink("dots/.") == 0){
    ...
    3886:	efe50513          	addi	a0,a0,-258 # 7780 <malloc+0x1ca2>
  ...
  if(unlink("dots/..") == 0){
    ...
    3898:	f1450513          	addi	a0,a0,-236 # 77a8 <malloc+0x1cca>
  ...
  if(unlink("dots") != 0){
    ...
    38aa:	e7250513          	addi	a0,a0,-398 # 7718 <malloc+0x1c3a>
    ...
    38c8:	e5c50513          	addi	a0,a0,-420 # 7720 <malloc+0x1c42>
    38cc:	00002097          	auipc	ra,0x2
    38d0:	154080e7          	jalr	340(ra) # 5a20 <printf>
    exit(1);
    38d4:	4505                	li	a0,1
    ...
    38e4:	e5850513          	addi	a0,a0,-424 # 7738 <malloc+0x1c5a>
    38e8:	00002097          	auipc	ra,0x2
    38ec:	138080e7          	jalr	312(ra) # 5a20 <printf>
    exit(1);
    38f0:	4505                	li	a0,1
    ...
    3900:	e5450513          	addi	a0,a0,-428 # 7750 <malloc+0x1c72>
    3904:	00002097          	auipc	ra,0x2
    3908:	11c080e7          	jalr	284(ra) # 5a20 <printf>
    exit(1);
    390c:	4505                	li	a0,1
    ...
    391c:	e5050513          	addi	a0,a0,-432 # 7768 <malloc+0x1c8a>
    3920:	00002097          	auipc	ra,0x2
    3924:	100080e7          	jalr	256(ra) # 5a20 <printf>
    exit(1);
    3928:	4505                	li	a0,1
    ...
    3938:	7ec50513          	addi	a0,a0,2028 # 7120 <malloc+0x1642>
    393c:	00002097          	auipc	ra,0x2
    3940:	0e4080e7          	jalr	228(ra) # 5a20 <printf>
    exit(1);
    3944:	4505                	li	a0,1
    ...
    3954:	e3850513          	addi	a0,a0,-456 # 7788 <malloc+0x1caa>
    3958:	00002097          	auipc	ra,0x2
    395c:	0c8080e7          	jalr	200(ra) # 5a20 <printf>
    exit(1);
    3960:	4505                	li	a0,1
    ...
    3970:	e4450513          	addi	a0,a0,-444 # 77b0 <malloc+0x1cd2>
    3974:	00002097          	auipc	ra,0x2
    3978:	0ac080e7          	jalr	172(ra) # 5a20 <printf>
    exit(1);
    397c:	4505                	li	a0,1
    ...
    398c:	e4850513          	addi	a0,a0,-440 # 77d0 <malloc+0x1cf2>
    3990:	00002097          	auipc	ra,0x2
    3994:	090080e7          	jalr	144(ra) # 5a20 <printf>
    exit(1);
    3998:	4505                	li	a0,1
...
00000000000039a2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    39b8:	51c50513          	addi	a0,a0,1308 # 5ed0 <malloc+0x3f2>
  ...
  if(chdir("dirfile") == 0){
    ...
    39d4:	50050513          	addi	a0,a0,1280 # 5ed0 <malloc+0x3f2>
  ...
  fd = open("dirfile/xx", 0);
    ...
    39e8:	e4c50513          	addi	a0,a0,-436 # 7830 <malloc+0x1d52>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3a00:	e3450513          	addi	a0,a0,-460 # 7830 <malloc+0x1d52>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3a14:	e2050513          	addi	a0,a0,-480 # 7830 <malloc+0x1d52>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3a28:	e0c50513          	addi	a0,a0,-500 # 7830 <malloc+0x1d52>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3a3c:	df858593          	addi	a1,a1,-520 # 7830 <malloc+0x1d52>
    3a40:	00002517          	auipc	a0,0x2
    3a44:	68850513          	addi	a0,a0,1672 # 60c8 <malloc+0x5ea>
  ...
  if(unlink("dirfile") != 0){
    ...
    3a58:	47c50513          	addi	a0,a0,1148 # 5ed0 <malloc+0x3f2>
  ...
  fd = open(".", O_RDWR);
    ...
    3a6e:	b5e50513          	addi	a0,a0,-1186 # 65c8 <malloc+0xaea>
  ...
  fd = open(".", 0);
    ...
    3a84:	b4850513          	addi	a0,a0,-1208 # 65c8 <malloc+0xaea>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3a98:	50c58593          	addi	a1,a1,1292 # 5fa0 <malloc+0x4c2>
  ...
  close(fd);
    ...
    3ac4:	d3050513          	addi	a0,a0,-720 # 77f0 <malloc+0x1d12>
    3ac8:	00002097          	auipc	ra,0x2
    3acc:	f58080e7          	jalr	-168(ra) # 5a20 <printf>
    exit(1);
    3ad0:	4505                	li	a0,1
    ...
    3ae0:	d3450513          	addi	a0,a0,-716 # 7810 <malloc+0x1d32>
    3ae4:	00002097          	auipc	ra,0x2
    3ae8:	f3c080e7          	jalr	-196(ra) # 5a20 <printf>
    exit(1);
    3aec:	4505                	li	a0,1
    ...
    3afc:	d4850513          	addi	a0,a0,-696 # 7840 <malloc+0x1d62>
    3b00:	00002097          	auipc	ra,0x2
    3b04:	f20080e7          	jalr	-224(ra) # 5a20 <printf>
    exit(1);
    3b08:	4505                	li	a0,1
    ...
    3b18:	d2c50513          	addi	a0,a0,-724 # 7840 <malloc+0x1d62>
    3b1c:	00002097          	auipc	ra,0x2
    3b20:	f04080e7          	jalr	-252(ra) # 5a20 <printf>
    exit(1);
    3b24:	4505                	li	a0,1
    ...
    3b34:	d3850513          	addi	a0,a0,-712 # 7868 <malloc+0x1d8a>
    3b38:	00002097          	auipc	ra,0x2
    3b3c:	ee8080e7          	jalr	-280(ra) # 5a20 <printf>
    exit(1);
    3b40:	4505                	li	a0,1
    ...
    3b50:	d4450513          	addi	a0,a0,-700 # 7890 <malloc+0x1db2>
    3b54:	00002097          	auipc	ra,0x2
    3b58:	ecc080e7          	jalr	-308(ra) # 5a20 <printf>
    exit(1);
    3b5c:	4505                	li	a0,1
    ...
    3b6c:	d5050513          	addi	a0,a0,-688 # 78b8 <malloc+0x1dda>
    3b70:	00002097          	auipc	ra,0x2
    3b74:	eb0080e7          	jalr	-336(ra) # 5a20 <printf>
    exit(1);
    3b78:	4505                	li	a0,1
    ...
    3b88:	d5c50513          	addi	a0,a0,-676 # 78e0 <malloc+0x1e02>
    3b8c:	00002097          	auipc	ra,0x2
    3b90:	e94080e7          	jalr	-364(ra) # 5a20 <printf>
    exit(1);
    3b94:	4505                	li	a0,1
    ...
    3ba4:	d6050513          	addi	a0,a0,-672 # 7900 <malloc+0x1e22>
    3ba8:	00002097          	auipc	ra,0x2
    3bac:	e78080e7          	jalr	-392(ra) # 5a20 <printf>
    exit(1);
    3bb0:	4505                	li	a0,1
    ...
    3bc0:	d6c50513          	addi	a0,a0,-660 # 7928 <malloc+0x1e4a>
    3bc4:	00002097          	auipc	ra,0x2
    3bc8:	e5c080e7          	jalr	-420(ra) # 5a20 <printf>
    exit(1);
    3bcc:	4505                	li	a0,1
...
0000000000003bd6 <iref>:
{
    ...
    3bf4:	d50a0a13          	addi	s4,s4,-688 # 7940 <malloc+0x1e62>
    mkdir("");
    3bf8:	00004497          	auipc	s1,0x4
    3bfc:	85848493          	addi	s1,s1,-1960 # 7450 <malloc+0x1972>
    link("README", "");
    3c00:	00002a97          	auipc	s5,0x2
    3c04:	4c8a8a93          	addi	s5,s5,1224 # 60c8 <malloc+0x5ea>
    fd = open("xx", O_CREATE);
    3c08:	00004997          	auipc	s3,0x4
    3c0c:	c3098993          	addi	s3,s3,-976 # 7838 <malloc+0x1d5a>
    3c10:	a891                	j	3c64 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3c12:	85da                	mv	a1,s6
    3c14:	00004517          	auipc	a0,0x4
    3c18:	d3450513          	addi	a0,a0,-716 # 7948 <malloc+0x1e6a>
    3c1c:	00002097          	auipc	ra,0x2
    3c20:	e04080e7          	jalr	-508(ra) # 5a20 <printf>
      exit(1);
    3c24:	4505                	li	a0,1
    ...
    3c34:	d3050513          	addi	a0,a0,-720 # 7960 <malloc+0x1e82>
    3c38:	00002097          	auipc	ra,0x2
    3c3c:	de8080e7          	jalr	-536(ra) # 5a20 <printf>
      exit(1);
    3c40:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3cc8:	4ac98993          	addi	s3,s3,1196 # 7170 <malloc+0x1692>
    unlink("irefd");
    3ccc:	00004917          	auipc	s2,0x4
    3cd0:	c7490913          	addi	s2,s2,-908 # 7940 <malloc+0x1e62>
    chdir("..");
    3cd4:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3cf0:	42c50513          	addi	a0,a0,1068 # 7118 <malloc+0x163a>
...
0000000000003d10 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3d20:	c5c50513          	addi	a0,a0,-932 # 7978 <malloc+0x1e9a>
  ...
  if(pid == 0){
    ...
    3d44:	c3850513          	addi	a0,a0,-968 # 7978 <malloc+0x1e9a>
    ...
    3d5a:	c4250513          	addi	a0,a0,-958 # 7998 <malloc+0x1eba>
    3d5e:	00002097          	auipc	ra,0x2
    3d62:	cc2080e7          	jalr	-830(ra) # 5a20 <printf>
      exit(1);
    3d66:	4505                	li	a0,1
    ...
    3d76:	c0e50513          	addi	a0,a0,-1010 # 7980 <malloc+0x1ea2>
    3d7a:	00002097          	auipc	ra,0x2
    3d7e:	ca6080e7          	jalr	-858(ra) # 5a20 <printf>
    exit(1);
    3d82:	4505                	li	a0,1
    ...
    3d92:	9da50513          	addi	a0,a0,-1574 # 6768 <malloc+0xc8a>
    3d96:	00002097          	auipc	ra,0x2
    3d9a:	c8a080e7          	jalr	-886(ra) # 5a20 <printf>
    exit(1);
    3d9e:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3dc0:	bbc50513          	addi	a0,a0,-1092 # 7978 <malloc+0x1e9a>
    ...
    3dd4:	b8850513          	addi	a0,a0,-1144 # 6958 <malloc+0xe7a>
    3dd8:	00002097          	auipc	ra,0x2
    3ddc:	c48080e7          	jalr	-952(ra) # 5a20 <printf>
    exit(1);
    3de0:	4505                	li	a0,1
...
0000000000003e02 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3e12:	bb250513          	addi	a0,a0,-1102 # 79c0 <malloc+0x1ee2>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3e3e:	b8650513          	addi	a0,a0,-1146 # 79c0 <malloc+0x1ee2>
  ...
  sleep(10); // one second
    ...
    3e76:	ab650513          	addi	a0,a0,-1354 # 6928 <malloc+0xe4a>
    3e7a:	00002097          	auipc	ra,0x2
    3e7e:	ba6080e7          	jalr	-1114(ra) # 5a20 <printf>
    exit(1);
    3e82:	4505                	li	a0,1
    ...
    3e90:	b3448493          	addi	s1,s1,-1228 # 79c0 <malloc+0x1ee2>
    3e94:	4581                	li	a1,0
    3e96:	8526                	mv	a0,s1
...
0000000000003ed2 <killstatus>:
{
  ...
  exit(0);
    ...
    3f38:	83450513          	addi	a0,a0,-1996 # 6768 <malloc+0xc8a>
    3f3c:	00002097          	auipc	ra,0x2
    3f40:	ae4080e7          	jalr	-1308(ra) # 5a20 <printf>
      exit(1);
    3f44:	4505                	li	a0,1
    ...
    3f5e:	a7650513          	addi	a0,a0,-1418 # 79d0 <malloc+0x1ef2>
    3f62:	00002097          	auipc	ra,0x2
    3f66:	abe080e7          	jalr	-1346(ra) # 5a20 <printf>
       exit(1);
    3f6a:	4505                	li	a0,1
...
0000000000003f74 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3f9e:	98e50513          	addi	a0,a0,-1650 # 6928 <malloc+0xe4a>
    3fa2:	00002097          	auipc	ra,0x2
    3fa6:	a7e080e7          	jalr	-1410(ra) # 5a20 <printf>
    exit(1);
    3faa:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3fcc:	7a050513          	addi	a0,a0,1952 # 6768 <malloc+0xc8a>
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	a50080e7          	jalr	-1456(ra) # 5a20 <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4010:	f9458593          	addi	a1,a1,-108 # 5fa0 <malloc+0x4c2>
    ...
    403a:	73250513          	addi	a0,a0,1842 # 6768 <malloc+0xc8a>
    403e:	00002097          	auipc	ra,0x2
    4042:	9e2080e7          	jalr	-1566(ra) # 5a20 <printf>
     exit(1);
    4046:	4505                	li	a0,1
    ...
    4056:	99e50513          	addi	a0,a0,-1634 # 79f0 <malloc+0x1f12>
    405a:	00002097          	auipc	ra,0x2
    405e:	9c6080e7          	jalr	-1594(ra) # 5a20 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4076:	b0658593          	addi	a1,a1,-1274 # bb78 <buf>
    ...
    4092:	97a50513          	addi	a0,a0,-1670 # 7a08 <malloc+0x1f2a>
    4096:	00002097          	auipc	ra,0x2
    409a:	98a080e7          	jalr	-1654(ra) # 5a20 <printf>
}
  ...
  printf("kill... ");
    ...
    40be:	96650513          	addi	a0,a0,-1690 # 7a20 <malloc+0x1f42>
    40c2:	00002097          	auipc	ra,0x2
    40c6:	95e080e7          	jalr	-1698(ra) # 5a20 <printf>
  kill(pid1);
    40ca:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    40ec:	94850513          	addi	a0,a0,-1720 # 7a30 <malloc+0x1f52>
    40f0:	00002097          	auipc	ra,0x2
    40f4:	930080e7          	jalr	-1744(ra) # 5a20 <printf>
  wait(0);
    40f8:	4501                	li	a0,0
...
0000000000004118 <reparent>:
{
  ...
  exit(0);
    ...
    416c:	60050513          	addi	a0,a0,1536 # 6768 <malloc+0xc8a>
    4170:	00002097          	auipc	ra,0x2
    4174:	8b0080e7          	jalr	-1872(ra) # 5a20 <printf>
      exit(1);
    4178:	4505                	li	a0,1
    ...
    4188:	76c50513          	addi	a0,a0,1900 # 68f0 <malloc+0xe12>
    418c:	00002097          	auipc	ra,0x2
    4190:	894080e7          	jalr	-1900(ra) # 5a20 <printf>
        exit(1);
    4194:	4505                	li	a0,1
...
00000000000041c8 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    41fe:	67650513          	addi	a0,a0,1654 # 6870 <malloc+0xd92>
    4202:	00002097          	auipc	ra,0x2
    4206:	81e080e7          	jalr	-2018(ra) # 5a20 <printf>
    exit(1);
    420a:	4505                	li	a0,1
    ...
    4232:	d7258593          	addi	a1,a1,-654 # 5fa0 <malloc+0x4c2>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    42f6:	74e50513          	addi	a0,a0,1870 # 7a40 <malloc+0x1f62>
    42fa:	00001097          	auipc	ra,0x1
    42fe:	726080e7          	jalr	1830(ra) # 5a20 <printf>
    exit(1);
    4302:	4505                	li	a0,1
    ...
    4312:	45a50513          	addi	a0,a0,1114 # 6768 <malloc+0xc8a>
    4316:	00001097          	auipc	ra,0x1
    431a:	70a080e7          	jalr	1802(ra) # 5a20 <printf>
    exit(1);
    431e:	4505                	li	a0,1
    ...
    4348:	6705                	lui	a4,0x1
      n += *(a+i);
    434a:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1478>
    ...
    435e:	70650513          	addi	a0,a0,1798 # 7a60 <malloc+0x1f82>
    4362:	00001097          	auipc	ra,0x1
    4366:	6be080e7          	jalr	1726(ra) # 5a20 <printf>
    exit(1);
    436a:	4505                	li	a0,1
...
000000000000437e <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    43c8:	71a080e7          	jalr	1818(ra) # 5ade <malloc>
    ...
    4402:	69250513          	addi	a0,a0,1682 # 7a90 <malloc+0x1fb2>
    4406:	00001097          	auipc	ra,0x1
    440a:	61a080e7          	jalr	1562(ra) # 5a20 <printf>
      exit(1);
    440e:	4505                	li	a0,1
...
0000000000004422 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    44b8:	5fc50513          	addi	a0,a0,1532 # 7ab0 <malloc+0x1fd2>
    44bc:	00001097          	auipc	ra,0x1
    44c0:	564080e7          	jalr	1380(ra) # 5a20 <printf>
    exit(1);
    44c4:	4505                	li	a0,1
    ...
    44d4:	60850513          	addi	a0,a0,1544 # 7ad8 <malloc+0x1ffa>
    44d8:	00001097          	auipc	ra,0x1
    44dc:	548080e7          	jalr	1352(ra) # 5a20 <printf>
      exit(1);
    44e0:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4518:	84c50513          	addi	a0,a0,-1972 # 5d60 <malloc+0x282>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4558:	5a450513          	addi	a0,a0,1444 # 7af8 <malloc+0x201a>
    455c:	00001097          	auipc	ra,0x1
    4560:	4c4080e7          	jalr	1220(ra) # 5a20 <printf>
    exit(1);
    4564:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4594:	7d050513          	addi	a0,a0,2000 # 5d60 <malloc+0x282>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    45ba:	56a50513          	addi	a0,a0,1386 # 7b20 <malloc+0x2042>
    45be:	00001097          	auipc	ra,0x1
    45c2:	462080e7          	jalr	1122(ra) # 5a20 <printf>
    exit(1);
    45c6:	4505                	li	a0,1
...
00000000000045da <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4600:	5cc78793          	addi	a5,a5,1484 # 5bc8 <malloc+0xea>
    4604:	f6f43823          	sd	a5,-144(s0)
    4608:	00001797          	auipc	a5,0x1
    460c:	5c878793          	addi	a5,a5,1480 # 5bd0 <malloc+0xf2>
    4610:	f6f43c23          	sd	a5,-136(s0)
    4614:	00001797          	auipc	a5,0x1
    4618:	5c478793          	addi	a5,a5,1476 # 5bd8 <malloc+0xfa>
    461c:	f8f43023          	sd	a5,-128(s0)
    4620:	00001797          	auipc	a5,0x1
    4624:	5c078793          	addi	a5,a5,1472 # 5be0 <malloc+0x102>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    467c:	500a0a13          	addi	s4,s4,1280 # bb78 <buf>
    4680:	00007a97          	auipc	s5,0x7
    4684:	4f9a8a93          	addi	s5,s5,1273 # bb79 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    469c:	4d850513          	addi	a0,a0,1240 # 6b70 <malloc+0x1092>
    46a0:	00001097          	auipc	ra,0x1
    46a4:	380080e7          	jalr	896(ra) # 5a20 <printf>
      exit(1);
    46a8:	4505                	li	a0,1
    ...
    4718:	42450513          	addi	a0,a0,1060 # 7b38 <malloc+0x205a>
    471c:	00001097          	auipc	ra,0x1
    4720:	304080e7          	jalr	772(ra) # 5a20 <printf>
        exit(1);
    4724:	4505                	li	a0,1
    ...
    4732:	41a50513          	addi	a0,a0,1050 # 7b48 <malloc+0x206a>
    4736:	00001097          	auipc	ra,0x1
    473a:	2ea080e7          	jalr	746(ra) # 5a20 <printf>
          exit(1);
    473e:	4505                	li	a0,1
    ...
    475a:	40a50513          	addi	a0,a0,1034 # 7b60 <malloc+0x2082>
    475e:	00001097          	auipc	ra,0x1
    4762:	2c2080e7          	jalr	706(ra) # 5a20 <printf>
          exit(1);
    4766:	4505                	li	a0,1
    ...
    478a:	3f278793          	addi	a5,a5,1010 # bb78 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    47e8:	38c50513          	addi	a0,a0,908 # 7b70 <malloc+0x2092>
    47ec:	00001097          	auipc	ra,0x1
    47f0:	234080e7          	jalr	564(ra) # 5a20 <printf>
      exit(1);
    47f4:	4505                	li	a0,1
...
000000000000481c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    484a:	342b8b93          	addi	s7,s7,834 # 7b88 <malloc+0x20aa>
  for(i = 0; i < N; i++){
    ...
    488c:	30850513          	addi	a0,a0,776 # 7b90 <malloc+0x20b2>
    4890:	00001097          	auipc	ra,0x1
    4894:	190080e7          	jalr	400(ra) # 5a20 <printf>
        exit(1);
    4898:	4505                	li	a0,1
    ...
    48aa:	2e250513          	addi	a0,a0,738 # 7b88 <malloc+0x20aa>
  ...
  fd = open(".", 0);
    ...
    48e2:	cea50513          	addi	a0,a0,-790 # 65c8 <malloc+0xaea>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4958:	25c50513          	addi	a0,a0,604 # 7bb0 <malloc+0x20d2>
    495c:	00001097          	auipc	ra,0x1
    4960:	0c4080e7          	jalr	196(ra) # 5a20 <printf>
        exit(1);
    4964:	4505                	li	a0,1
    ...
    4978:	25c50513          	addi	a0,a0,604 # 7bd0 <malloc+0x20f2>
    497c:	00001097          	auipc	ra,0x1
    4980:	0a4080e7          	jalr	164(ra) # 5a20 <printf>
        exit(1);
    4984:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    49b0:	24c50513          	addi	a0,a0,588 # 7bf8 <malloc+0x211a>
    49b4:	00001097          	auipc	ra,0x1
    49b8:	06c080e7          	jalr	108(ra) # 5a20 <printf>
    exit(1);
    49bc:	4505                	li	a0,1
    ...
    49cc:	da050513          	addi	a0,a0,-608 # 6768 <malloc+0xc8a>
    49d0:	00001097          	auipc	ra,0x1
    49d4:	050080e7          	jalr	80(ra) # 5a20 <printf>
      exit(1);
    49d8:	4505                	li	a0,1
...
0000000000004b76 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4bb6:	fc690913          	addi	s2,s2,-58 # bb78 <buf>
  for(i = 0; i < N; i++){
    4bba:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4bfe:	03650513          	addi	a0,a0,54 # 7c30 <malloc+0x2152>
  ...
  for(i = 0; ; i++){
    ...
    4c14:	f6890913          	addi	s2,s2,-152 # bb78 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4c62:	fe250513          	addi	a0,a0,-30 # 7c40 <malloc+0x2162>
    4c66:	00001097          	auipc	ra,0x1
    4c6a:	dba080e7          	jalr	-582(ra) # 5a20 <printf>
    exit(1);
    4c6e:	4505                	li	a0,1
    ...
    4c7e:	fe650513          	addi	a0,a0,-26 # 7c60 <malloc+0x2182>
    4c82:	00001097          	auipc	ra,0x1
    4c86:	d9e080e7          	jalr	-610(ra) # 5a20 <printf>
      exit(1);
    4c8a:	4505                	li	a0,1
    ...
    4c9a:	fea50513          	addi	a0,a0,-22 # 7c80 <malloc+0x21a2>
    4c9e:	00001097          	auipc	ra,0x1
    4ca2:	d82080e7          	jalr	-638(ra) # 5a20 <printf>
    exit(1);
    4ca6:	4505                	li	a0,1
    ...
    4cb6:	fee50513          	addi	a0,a0,-18 # 7ca0 <malloc+0x21c2>
    4cba:	00001097          	auipc	ra,0x1
    4cbe:	d66080e7          	jalr	-666(ra) # 5a20 <printf>
      exit(1);
    4cc2:	4505                	li	a0,1
    ...
    4cd2:	ff250513          	addi	a0,a0,-14 # 7cc0 <malloc+0x21e2>
    4cd6:	00001097          	auipc	ra,0x1
    4cda:	d4a080e7          	jalr	-694(ra) # 5a20 <printf>
      exit(1);
    4cde:	4505                	li	a0,1
    ...
    4cee:	fee50513          	addi	a0,a0,-18 # 7cd8 <malloc+0x21fa>
    4cf2:	00001097          	auipc	ra,0x1
    4cf6:	d2e080e7          	jalr	-722(ra) # 5a20 <printf>
      exit(1);
    4cfa:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4d1c:	f1850513          	addi	a0,a0,-232 # 7c30 <malloc+0x2152>
    ...
    4d40:	fbc50513          	addi	a0,a0,-68 # 7cf8 <malloc+0x221a>
    4d44:	00001097          	auipc	ra,0x1
    4d48:	cdc080e7          	jalr	-804(ra) # 5a20 <printf>
    exit(1);
    4d4c:	4505                	li	a0,1
...
0000000000004d56 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4d78:	fa450513          	addi	a0,a0,-92 # 7d18 <malloc+0x223a>
    4d7c:	00001097          	auipc	ra,0x1
    4d80:	ca4080e7          	jalr	-860(ra) # 5a20 <printf>
  for(nfiles = 0; ; nfiles++){
    4d84:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4d98:	f94c8c93          	addi	s9,s9,-108 # 7d28 <malloc+0x224a>
    int total = 0;
    4d9c:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4d9e:	00007a17          	auipc	s4,0x7
    4da2:	ddaa0a13          	addi	s4,s4,-550 # bb78 <buf>
    name[0] = 'f';
    ...
    4df0:	c34080e7          	jalr	-972(ra) # 5a20 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4e12:	f2a50513          	addi	a0,a0,-214 # 7d38 <malloc+0x225a>
    4e16:	00001097          	auipc	ra,0x1
    4e1a:	c0a080e7          	jalr	-1014(ra) # 5a20 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4e88:	ed450513          	addi	a0,a0,-300 # 7d58 <malloc+0x227a>
    4e8c:	00001097          	auipc	ra,0x1
    4e90:	b94080e7          	jalr	-1132(ra) # 5a20 <printf>
}
    ...
    4ed8:	e7450513          	addi	a0,a0,-396 # 7d48 <malloc+0x226a>
    4edc:	00001097          	auipc	ra,0x1
    4ee0:	b44080e7          	jalr	-1212(ra) # 5a20 <printf>
    close(fd);
    4ee4:	854a                	mv	a0,s2
...
0000000000004ef6 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4f00:	45470713          	addi	a4,a4,1108 # 8350 <randstate>
    4f04:	6308                	ld	a0,0(a4)
    4f06:	001967b7          	lui	a5,0x196
    4f0a:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x187a85>
    4f0e:	02f50533          	mul	a0,a0,a5
    4f12:	3c6ef7b7          	lui	a5,0x3c6ef
    4f16:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e07d7>
...
0000000000004f26 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4f9a:	dda50513          	addi	a0,a0,-550 # 7d70 <malloc+0x2292>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4fb2:	ff258593          	addi	a1,a1,-14 # 5fa0 <malloc+0x4c2>
    ...
    4fc8:	dcc50513          	addi	a0,a0,-564 # 7d90 <malloc+0x22b2>
    4fcc:	00001097          	auipc	ra,0x1
    4fd0:	a54080e7          	jalr	-1452(ra) # 5a20 <printf>
    exit(1);
    4fd4:	4505                	li	a0,1
    ...
    4fe2:	d9a50513          	addi	a0,a0,-614 # 7d78 <malloc+0x229a>
    4fe6:	00001097          	auipc	ra,0x1
    4fea:	a3a080e7          	jalr	-1478(ra) # 5a20 <printf>
      exit(1);
    4fee:	4505                	li	a0,1
    ...
    4ffc:	d8050513          	addi	a0,a0,-640 # 7d78 <malloc+0x229a>
    5000:	00001097          	auipc	ra,0x1
    5004:	a20080e7          	jalr	-1504(ra) # 5a20 <printf>
    exit(1);
    5008:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    5020:	d5450513          	addi	a0,a0,-684 # 7d70 <malloc+0x2292>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5076:	f2e98993          	addi	s3,s3,-210 # 5fa0 <malloc+0x4c2>
      uint64 a = (uint64) sbrk(4096);
    ...
    50a8:	d3c50513          	addi	a0,a0,-708 # 7de0 <malloc+0x2302>
    50ac:	00001097          	auipc	ra,0x1
    50b0:	974080e7          	jalr	-1676(ra) # 5a20 <printf>
        exit(1);
    50b4:	4505                	li	a0,1
    ...
    50c2:	ce250513          	addi	a0,a0,-798 # 7da0 <malloc+0x22c2>
    50c6:	00001097          	auipc	ra,0x1
    50ca:	95a080e7          	jalr	-1702(ra) # 5a20 <printf>
    exit(1);
    50ce:	4505                	li	a0,1
    ...
    50dc:	ce850513          	addi	a0,a0,-792 # 7dc0 <malloc+0x22e2>
    50e0:	00001097          	auipc	ra,0x1
    50e4:	940080e7          	jalr	-1728(ra) # 5a20 <printf>
    exit(1);
    50e8:	4505                	li	a0,1
  ...
  while(1){
    ...
    512a:	cda50513          	addi	a0,a0,-806 # 7e00 <malloc+0x2322>
    512e:	00001097          	auipc	ra,0x1
    5132:	8f2080e7          	jalr	-1806(ra) # 5a20 <printf>
      exit(1);
    5136:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    517a:	caa50513          	addi	a0,a0,-854 # 7e20 <malloc+0x2342>
    517e:	00001097          	auipc	ra,0x1
    5182:	8a2080e7          	jalr	-1886(ra) # 5a20 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    51aa:	ca250513          	addi	a0,a0,-862 # 7e48 <malloc+0x236a>
    51ae:	00001097          	auipc	ra,0x1
    51b2:	872080e7          	jalr	-1934(ra) # 5a20 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    51ce:	c6650513          	addi	a0,a0,-922 # 7e30 <malloc+0x2352>
    51d2:	00001097          	auipc	ra,0x1
    51d6:	84e080e7          	jalr	-1970(ra) # 5a20 <printf>
    exit(1);
    51da:	4505                	li	a0,1
    ...
    51f6:	c5e50513          	addi	a0,a0,-930 # 7e50 <malloc+0x2372>
    51fa:	00001097          	auipc	ra,0x1
    51fe:	826080e7          	jalr	-2010(ra) # 5a20 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    5240:	d2c78793          	addi	a5,a5,-724 # 7f68 <malloc+0x248a>
    5244:	c0040713          	addi	a4,s0,-1024
    5248:	00003817          	auipc	a6,0x3
    524c:	0e080813          	addi	a6,a6,224 # 8328 <malloc+0x284a>
  ...
  printf("usertests starting\n");
    ...
    5270:	c9c50513          	addi	a0,a0,-868 # 7f08 <malloc+0x242a>
    5274:	00000097          	auipc	ra,0x0
    5278:	7ac080e7          	jalr	1964(ra) # 5a20 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    52a8:	c1c50513          	addi	a0,a0,-996 # 7ec0 <malloc+0x23e2>
    52ac:	00000097          	auipc	ra,0x0
    52b0:	774080e7          	jalr	1908(ra) # 5a20 <printf>
    exit(1);
    52b4:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    52c4:	b9858593          	addi	a1,a1,-1128 # 7e58 <malloc+0x237a>
    ...
    52da:	c6a58593          	addi	a1,a1,-918 # 7f40 <malloc+0x2462>
    ...
    52fe:	b6650513          	addi	a0,a0,-1178 # 7e60 <malloc+0x2382>
    5302:	00000097          	auipc	ra,0x0
    5306:	71e080e7          	jalr	1822(ra) # 5a20 <printf>
    exit(1);
    530a:	4505                	li	a0,1
    ...
    5328:	6fc080e7          	jalr	1788(ra) # 5a20 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    536a:	b4250513          	addi	a0,a0,-1214 # 7ea8 <malloc+0x23ca>
    536e:	00000097          	auipc	ra,0x0
    5372:	6b2080e7          	jalr	1714(ra) # 5a20 <printf>
    exit(1);
    5376:	4505                	li	a0,1
    ...
    5384:	b7050513          	addi	a0,a0,-1168 # 7ef0 <malloc+0x2412>
    5388:	00000097          	auipc	ra,0x0
    538c:	698080e7          	jalr	1688(ra) # 5a20 <printf>
    exit(0);
    5390:	4501                	li	a0,0
    ...
    53a0:	684080e7          	jalr	1668(ra) # 5a20 <printf>
        if(continuous != 2)
    ...
    53e2:	b8a78793          	addi	a5,a5,-1142 # 7f68 <malloc+0x248a>
    53e6:	c0040713          	addi	a4,s0,-1024
    53ea:	00003817          	auipc	a6,0x3
    53ee:	f3e80813          	addi	a6,a6,-194 # 8328 <malloc+0x284a>
    ...
    5412:	b1250513          	addi	a0,a0,-1262 # 7f20 <malloc+0x2442>
    5416:	00000097          	auipc	ra,0x0
    541a:	60a080e7          	jalr	1546(ra) # 5a20 <printf>
        printf("SOME TESTS FAILED\n");
    541e:	00003a97          	auipc	s5,0x3
    5422:	a8aa8a93          	addi	s5,s5,-1398 # 7ea8 <malloc+0x23ca>
        if(continuous != 2)
    5426:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    5428:	00003b17          	auipc	s6,0x3
    542c:	a60b0b13          	addi	s6,s6,-1440 # 7e88 <malloc+0x23aa>
...
putc(int fd, char c)
{
    5748:	1101                	addi	sp,sp,-32
    574a:	ec06                	sd	ra,24(sp)
    574c:	e822                	sd	s0,16(sp)
    574e:	1000                	addi	s0,sp,32
    5750:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5754:	4605                	li	a2,1
    5756:	fef40593          	addi	a1,s0,-17
    575a:	00000097          	auipc	ra,0x0
    575e:	f66080e7          	jalr	-154(ra) # 56c0 <write>
}
    5762:	60e2                	ld	ra,24(sp)
    5764:	6442                	ld	s0,16(sp)
    5766:	6105                	addi	sp,sp,32
    5768:	8082                	ret

000000000000576a <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    576a:	7139                	addi	sp,sp,-64
    576c:	fc06                	sd	ra,56(sp)
    576e:	f822                	sd	s0,48(sp)
    5770:	f426                	sd	s1,40(sp)
    5772:	f04a                	sd	s2,32(sp)
    5774:	ec4e                	sd	s3,24(sp)
    5776:	0080                	addi	s0,sp,64
    5778:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    577a:	c299                	beqz	a3,5780 <printint+0x16>
    577c:	0805c863          	bltz	a1,580c <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5780:	2581                	sext.w	a1,a1
  neg = 0;
    5782:	4881                	li	a7,0
    5784:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    578a:	2601                	sext.w	a2,a2
    578c:	00003517          	auipc	a0,0x3
    5790:	ba450513          	addi	a0,a0,-1116 # 8330 <digits>
    5794:	883a                	mv	a6,a4
    5796:	2705                	addiw	a4,a4,1
    5798:	02c5f7bb          	remuw	a5,a1,a2
    579c:	1782                	slli	a5,a5,0x20
    579e:	9381                	srli	a5,a5,0x20
    57a0:	97aa                	add	a5,a5,a0
    57a2:	0007c783          	lbu	a5,0(a5)
    57a6:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    57aa:	0005879b          	sext.w	a5,a1
    57ae:	02c5d5bb          	divuw	a1,a1,a2
    57b2:	0685                	addi	a3,a3,1
    57b4:	fec7f0e3          	bgeu	a5,a2,5794 <printint+0x2a>
  if(neg)
    57b8:	00088b63          	beqz	a7,57ce <printint+0x64>
    buf[i++] = '-';
    57bc:	fd040793          	addi	a5,s0,-48
    57c0:	973e                	add	a4,a4,a5
    57c2:	02d00793          	li	a5,45
    57c6:	fef70823          	sb	a5,-16(a4)
    57ca:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    57ce:	02e05863          	blez	a4,57fe <printint+0x94>
    57d2:	fc040793          	addi	a5,s0,-64
    57d6:	00e78933          	add	s2,a5,a4
    57da:	fff78993          	addi	s3,a5,-1
    57de:	99ba                	add	s3,s3,a4
    57e0:	377d                	addiw	a4,a4,-1
    57e2:	1702                	slli	a4,a4,0x20
    57e4:	9301                	srli	a4,a4,0x20
    57e6:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    57ea:	fff94583          	lbu	a1,-1(s2)
    57ee:	8526                	mv	a0,s1
    57f0:	00000097          	auipc	ra,0x0
    57f4:	f58080e7          	jalr	-168(ra) # 5748 <putc>
  while(--i >= 0)
    57f8:	197d                	addi	s2,s2,-1
    57fa:	ff3918e3          	bne	s2,s3,57ea <printint+0x80>
}
    57fe:	70e2                	ld	ra,56(sp)
    5800:	7442                	ld	s0,48(sp)
    5802:	74a2                	ld	s1,40(sp)
    5804:	7902                	ld	s2,32(sp)
    5806:	69e2                	ld	s3,24(sp)
    5808:	6121                	addi	sp,sp,64
    580a:	8082                	ret
    x = -xx;
    580c:	40b005bb          	negw	a1,a1
    neg = 1;
    5810:	4885                	li	a7,1
    x = -xx;
    5812:	bf8d                	j	5784 <printint+0x1a>

0000000000005814 <vprintf>:
}
...
{
    5814:	7119                	addi	sp,sp,-128
    5816:	fc86                	sd	ra,120(sp)
    5818:	f8a2                	sd	s0,112(sp)
    581a:	f4a6                	sd	s1,104(sp)
    581c:	f0ca                	sd	s2,96(sp)
    581e:	ecce                	sd	s3,88(sp)
    5820:	e8d2                	sd	s4,80(sp)
    5822:	e4d6                	sd	s5,72(sp)
    5824:	e0da                	sd	s6,64(sp)
    5826:	fc5e                	sd	s7,56(sp)
    5828:	f862                	sd	s8,48(sp)
    582a:	f466                	sd	s9,40(sp)
    582c:	f06a                	sd	s10,32(sp)
    582e:	ec6e                	sd	s11,24(sp)
    5830:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5832:	0005c903          	lbu	s2,0(a1)
    5836:	18090f63          	beqz	s2,59d4 <vprintf+0x1c0>
    583a:	8aaa                	mv	s5,a0
    583c:	8b32                	mv	s6,a2
    583e:	00158493          	addi	s1,a1,1
  state = 0;
    5842:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5844:	02500a13          	li	s4,37
      if(c == 'd'){
    5848:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    584c:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5850:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5854:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5858:	00003b97          	auipc	s7,0x3
    585c:	ad8b8b93          	addi	s7,s7,-1320 # 8330 <digits>
    5860:	a839                	j	587e <vprintf+0x6a>
        putc(fd, c);
    5862:	85ca                	mv	a1,s2
    5864:	8556                	mv	a0,s5
    5866:	00000097          	auipc	ra,0x0
    586a:	ee2080e7          	jalr	-286(ra) # 5748 <putc>
    586e:	a019                	j	5874 <vprintf+0x60>
    } else if(state == '%'){
    5870:	01498f63          	beq	s3,s4,588e <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5874:	0485                	addi	s1,s1,1
    5876:	fff4c903          	lbu	s2,-1(s1)
    587a:	14090d63          	beqz	s2,59d4 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    587e:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5882:	fe0997e3          	bnez	s3,5870 <vprintf+0x5c>
      if(c == '%'){
    5886:	fd479ee3          	bne	a5,s4,5862 <vprintf+0x4e>
        state = '%';
    588a:	89be                	mv	s3,a5
    588c:	b7e5                	j	5874 <vprintf+0x60>
      if(c == 'd'){
    588e:	05878063          	beq	a5,s8,58ce <vprintf+0xba>
      } else if(c == 'l') {
    5892:	05978c63          	beq	a5,s9,58ea <vprintf+0xd6>
      } else if(c == 'x') {
    5896:	07a78863          	beq	a5,s10,5906 <vprintf+0xf2>
      } else if(c == 'p') {
    589a:	09b78463          	beq	a5,s11,5922 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    589e:	07300713          	li	a4,115
    58a2:	0ce78663          	beq	a5,a4,596e <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    58a6:	06300713          	li	a4,99
    58aa:	0ee78e63          	beq	a5,a4,59a6 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    58ae:	11478863          	beq	a5,s4,59be <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    58ba:	e92080e7          	jalr	-366(ra) # 5748 <putc>
        putc(fd, c);
    58be:	85ca                	mv	a1,s2
    58c0:	8556                	mv	a0,s5
    58c2:	00000097          	auipc	ra,0x0
    58c6:	e86080e7          	jalr	-378(ra) # 5748 <putc>
      }
      state = 0;
    58ca:	4981                	li	s3,0
    58cc:	b765                	j	5874 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    58ce:	008b0913          	addi	s2,s6,8
    58d2:	4685                	li	a3,1
    58d4:	4629                	li	a2,10
    58d6:	000b2583          	lw	a1,0(s6)
    58da:	8556                	mv	a0,s5
    58dc:	00000097          	auipc	ra,0x0
    58e0:	e8e080e7          	jalr	-370(ra) # 576a <printint>
    58e4:	8b4a                	mv	s6,s2
      state = 0;
    58e6:	4981                	li	s3,0
    58e8:	b771                	j	5874 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    58fc:	e72080e7          	jalr	-398(ra) # 576a <printint>
    5900:	8b4a                	mv	s6,s2
      state = 0;
    5902:	4981                	li	s3,0
    5904:	bf85                	j	5874 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    5918:	e56080e7          	jalr	-426(ra) # 576a <printint>
    591c:	8b4a                	mv	s6,s2
      state = 0;
    591e:	4981                	li	s3,0
    5920:	bf91                	j	5874 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5922:	008b0793          	addi	a5,s6,8
    5926:	f8f43423          	sd	a5,-120(s0)
    592a:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    592e:	03000593          	li	a1,48
    5932:	8556                	mv	a0,s5
    5934:	00000097          	auipc	ra,0x0
    5938:	e14080e7          	jalr	-492(ra) # 5748 <putc>
  putc(fd, 'x');
    593c:	85ea                	mv	a1,s10
    593e:	8556                	mv	a0,s5
    5940:	00000097          	auipc	ra,0x0
    5944:	e08080e7          	jalr	-504(ra) # 5748 <putc>
    5948:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    594a:	03c9d793          	srli	a5,s3,0x3c
    594e:	97de                	add	a5,a5,s7
    5950:	0007c583          	lbu	a1,0(a5)
    5954:	8556                	mv	a0,s5
    5956:	00000097          	auipc	ra,0x0
    595a:	df2080e7          	jalr	-526(ra) # 5748 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    595e:	0992                	slli	s3,s3,0x4
    5960:	397d                	addiw	s2,s2,-1
    5962:	fe0914e3          	bnez	s2,594a <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5966:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    596a:	4981                	li	s3,0
    596c:	b721                	j	5874 <vprintf+0x60>
        s = va_arg(ap, char*);
    596e:	008b0993          	addi	s3,s6,8
    5972:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5976:	02090163          	beqz	s2,5998 <vprintf+0x184>
        while(*s != 0){
    597a:	00094583          	lbu	a1,0(s2)
    597e:	c9a1                	beqz	a1,59ce <vprintf+0x1ba>
          putc(fd, *s);
    5980:	8556                	mv	a0,s5
    5982:	00000097          	auipc	ra,0x0
    5986:	dc6080e7          	jalr	-570(ra) # 5748 <putc>
          s++;
    598a:	0905                	addi	s2,s2,1
        while(*s != 0){
    598c:	00094583          	lbu	a1,0(s2)
    5990:	f9e5                	bnez	a1,5980 <vprintf+0x16c>
        s = va_arg(ap, char*);
    5992:	8b4e                	mv	s6,s3
      state = 0;
    5994:	4981                	li	s3,0
    5996:	bdf9                	j	5874 <vprintf+0x60>
          s = "(null)";
    5998:	00003917          	auipc	s2,0x3
    599c:	99090913          	addi	s2,s2,-1648 # 8328 <malloc+0x284a>
        while(*s != 0){
    59a0:	02800593          	li	a1,40
    59a4:	bff1                	j	5980 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    59a6:	008b0913          	addi	s2,s6,8
    59aa:	000b4583          	lbu	a1,0(s6)
    59ae:	8556                	mv	a0,s5
    59b0:	00000097          	auipc	ra,0x0
    59b4:	d98080e7          	jalr	-616(ra) # 5748 <putc>
    59b8:	8b4a                	mv	s6,s2
      state = 0;
    59ba:	4981                	li	s3,0
    59bc:	bd65                	j	5874 <vprintf+0x60>
        putc(fd, c);
    59be:	85d2                	mv	a1,s4
    59c0:	8556                	mv	a0,s5
    59c2:	00000097          	auipc	ra,0x0
    59c6:	d86080e7          	jalr	-634(ra) # 5748 <putc>
      state = 0;
    59ca:	4981                	li	s3,0
    59cc:	b565                	j	5874 <vprintf+0x60>
        s = va_arg(ap, char*);
    59ce:	8b4e                	mv	s6,s3
      state = 0;
    59d0:	4981                	li	s3,0
    59d2:	b54d                	j	5874 <vprintf+0x60>
    }
  }
}
    59d4:	70e6                	ld	ra,120(sp)
    59d6:	7446                	ld	s0,112(sp)
    59d8:	74a6                	ld	s1,104(sp)
    59da:	7906                	ld	s2,96(sp)
    59dc:	69e6                	ld	s3,88(sp)
    59de:	6a46                	ld	s4,80(sp)
    59e0:	6aa6                	ld	s5,72(sp)
    59e2:	6b06                	ld	s6,64(sp)
    59e4:	7be2                	ld	s7,56(sp)
    59e6:	7c42                	ld	s8,48(sp)
    59e8:	7ca2                	ld	s9,40(sp)
    59ea:	7d02                	ld	s10,32(sp)
    59ec:	6de2                	ld	s11,24(sp)
    59ee:	6109                	addi	sp,sp,128
    59f0:	8082                	ret

00000000000059f2 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    59f2:	715d                	addi	sp,sp,-80
    59f4:	ec06                	sd	ra,24(sp)
    59f6:	e822                	sd	s0,16(sp)
    59f8:	1000                	addi	s0,sp,32
    59fa:	e010                	sd	a2,0(s0)
    59fc:	e414                	sd	a3,8(s0)
    59fe:	e818                	sd	a4,16(s0)
    5a00:	ec1c                	sd	a5,24(s0)
    5a02:	03043023          	sd	a6,32(s0)
    5a06:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5a0a:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5a0e:	8622                	mv	a2,s0
    5a10:	00000097          	auipc	ra,0x0
    5a14:	e04080e7          	jalr	-508(ra) # 5814 <vprintf>
}
    5a18:	60e2                	ld	ra,24(sp)
    5a1a:	6442                	ld	s0,16(sp)
    5a1c:	6161                	addi	sp,sp,80
    5a1e:	8082                	ret

0000000000005a20 <printf>:

void
printf(const char *fmt, ...)
{
    5a20:	711d                	addi	sp,sp,-96
    5a22:	ec06                	sd	ra,24(sp)
    5a24:	e822                	sd	s0,16(sp)
    5a26:	1000                	addi	s0,sp,32
    5a28:	e40c                	sd	a1,8(s0)
    5a2a:	e810                	sd	a2,16(s0)
    5a2c:	ec14                	sd	a3,24(s0)
    5a2e:	f018                	sd	a4,32(s0)
    5a30:	f41c                	sd	a5,40(s0)
    5a32:	03043823          	sd	a6,48(s0)
    5a36:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5a3a:	00840613          	addi	a2,s0,8
    5a3e:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5a42:	85aa                	mv	a1,a0
    5a44:	4505                	li	a0,1
    5a46:	00000097          	auipc	ra,0x0
    5a4a:	dce080e7          	jalr	-562(ra) # 5814 <vprintf>
}
    5a4e:	60e2                	ld	ra,24(sp)
    5a50:	6442                	ld	s0,16(sp)
    5a52:	6125                	addi	sp,sp,96
    5a54:	8082                	ret

0000000000005a56 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5a56:	1141                	addi	sp,sp,-16
    5a58:	e422                	sd	s0,8(sp)
    5a5a:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5a5c:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5a60:	00003797          	auipc	a5,0x3
    5a64:	8f87b783          	ld	a5,-1800(a5) # 8358 <freep>
    5a68:	a805                	j	5a98 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5a6a:	4618                	lw	a4,8(a2)
    5a6c:	9db9                	addw	a1,a1,a4
    5a6e:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5a72:	6398                	ld	a4,0(a5)
    5a74:	6318                	ld	a4,0(a4)
    5a76:	fee53823          	sd	a4,-16(a0)
    5a7a:	a091                	j	5abe <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5a7c:	ff852703          	lw	a4,-8(a0)
    5a80:	9e39                	addw	a2,a2,a4
    5a82:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5a84:	ff053703          	ld	a4,-16(a0)
    5a88:	e398                	sd	a4,0(a5)
    5a8a:	a099                	j	5ad0 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5a8c:	6398                	ld	a4,0(a5)
    5a8e:	00e7e463          	bltu	a5,a4,5a96 <free+0x40>
    5a92:	00e6ea63          	bltu	a3,a4,5aa6 <free+0x50>
{
    5a96:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5a98:	fed7fae3          	bgeu	a5,a3,5a8c <free+0x36>
    5a9c:	6398                	ld	a4,0(a5)
    5a9e:	00e6e463          	bltu	a3,a4,5aa6 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5aa2:	fee7eae3          	bltu	a5,a4,5a96 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5aa6:	ff852583          	lw	a1,-8(a0)
    5aaa:	6390                	ld	a2,0(a5)
    5aac:	02059813          	slli	a6,a1,0x20
    5ab0:	01c85713          	srli	a4,a6,0x1c
    5ab4:	9736                	add	a4,a4,a3
    5ab6:	fae60ae3          	beq	a2,a4,5a6a <free+0x14>
    bp->s.ptr = p->s.ptr;
    5aba:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5abe:	4790                	lw	a2,8(a5)
    5ac0:	02061593          	slli	a1,a2,0x20
    5ac4:	01c5d713          	srli	a4,a1,0x1c
    5ac8:	973e                	add	a4,a4,a5
    5aca:	fae689e3          	beq	a3,a4,5a7c <free+0x26>
  } else
    p->s.ptr = bp;
    5ace:	e394                	sd	a3,0(a5)
  freep = p;
    5ad0:	00003717          	auipc	a4,0x3
    5ad4:	88f73423          	sd	a5,-1912(a4) # 8358 <freep>
}
    5ad8:	6422                	ld	s0,8(sp)
    5ada:	0141                	addi	sp,sp,16
    5adc:	8082                	ret

0000000000005ade <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5ade:	7139                	addi	sp,sp,-64
    5ae0:	fc06                	sd	ra,56(sp)
    5ae2:	f822                	sd	s0,48(sp)
    5ae4:	f426                	sd	s1,40(sp)
    5ae6:	f04a                	sd	s2,32(sp)
    5ae8:	ec4e                	sd	s3,24(sp)
    5aea:	e852                	sd	s4,16(sp)
    5aec:	e456                	sd	s5,8(sp)
    5aee:	e05a                	sd	s6,0(sp)
    5af0:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5af2:	02051493          	slli	s1,a0,0x20
    5af6:	9081                	srli	s1,s1,0x20
    5af8:	04bd                	addi	s1,s1,15
    5afa:	8091                	srli	s1,s1,0x4
    5afc:	0014899b          	addiw	s3,s1,1
    5b00:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5b02:	00003517          	auipc	a0,0x3
    5b06:	85653503          	ld	a0,-1962(a0) # 8358 <freep>
    5b0a:	c515                	beqz	a0,5b36 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    5b10:	02977f63          	bgeu	a4,s1,5b4e <malloc+0x70>
    5b14:	8a4e                	mv	s4,s3
    5b16:	0009871b          	sext.w	a4,s3
    5b1a:	6685                	lui	a3,0x1
    5b1c:	00d77363          	bgeu	a4,a3,5b22 <malloc+0x44>
    5b20:	6a05                	lui	s4,0x1
    5b22:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5b26:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5b2a:	00003917          	auipc	s2,0x3
    5b2e:	82e90913          	addi	s2,s2,-2002 # 8358 <freep>
  if(p == (char*)-1)
    5b32:	5afd                	li	s5,-1
    5b34:	a895                	j	5ba8 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5b36:	00009797          	auipc	a5,0x9
    5b3a:	04278793          	addi	a5,a5,66 # eb78 <base>
    5b3e:	00003717          	auipc	a4,0x3
    5b42:	80f73d23          	sd	a5,-2022(a4) # 8358 <freep>
    5b46:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5b48:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5b4c:	b7e1                	j	5b14 <malloc+0x36>
      if(p->s.size == nunits)
    5b4e:	02e48c63          	beq	s1,a4,5b86 <malloc+0xa8>
        p->s.size -= nunits;
    5b52:	4137073b          	subw	a4,a4,s3
    5b56:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5b58:	02071693          	slli	a3,a4,0x20
    5b5c:	01c6d713          	srli	a4,a3,0x1c
    ...
    5b8a:	bff1                	j	5b66 <malloc+0x88>
  hp->s.size = nu;
    5b8c:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5b90:	0541                	addi	a0,a0,16
    5b92:	00000097          	auipc	ra,0x0
    5b96:	ec4080e7          	jalr	-316(ra) # 5a56 <free>
  return freep;
    5b9a:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5b9e:	d971                	beqz	a0,5b72 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5ba0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5ba2:	4798                	lw	a4,8(a5)
    5ba4:	fa9775e3          	bgeu	a4,s1,5b4e <malloc+0x70>
    if(p == freep)
    5ba8:	00093703          	ld	a4,0(s2)
    5bac:	853e                	mv	a0,a5
    5bae:	fef719e3          	bne	a4,a5,5ba0 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5bb2:	8552                	mv	a0,s4
    5bb4:	00000097          	auipc	ra,0x0
    5bb8:	b74080e7          	jalr	-1164(ra) # 5728 <sbrk>
  if(p == (char*)-1)
    5bbc:	fd5518e3          	bne	a0,s5,5b8c <malloc+0xae>
        return 0;
    5bc0:	4501                	li	a0,0
    5bc2:	bf45                	j	5b72 <malloc+0x94>
